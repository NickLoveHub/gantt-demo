...
!function (t) {
    ...
    function r(t) {
        var e = t.$gantt.$data.tasksStore, i = t.$config.rowStore, n = "_attached_" + i.name;
        ...
        return {
            init: function () {
                ...
                if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
                    ...
                    }, 300), s = "_attached_" + e.name;
                    t.$attachedResourceViewHandler || (t.$attachedResourceViewHandler = !0, i[s] = t.attachEvent("onStoreUpdated", a)), e.$attachedResourceViewHandler || (e.$attachedResourceViewHandler = e.attachEvent("onBeforeStoreUpdate", function () {
    ...
    var n = i(1), r = i(0), a = i(4), s = i(119), o = i(29), l = function (t, e, i, n) {
    ...
    l.prototype = {
        init: function (t) {
            ...
            var l = s(e, this);
            l.init(), this._renderHeaderResizers = l.doOnRender, this._mouseDelegates = i(13)(e), this._addLayers(this.$gantt), this._initEvents(), this.callEvent("onReady", [])
    ...
    var n = i(25), r = i(0), a = i(26), s = function (t) {
    ...
    var n = i(25), r = i(0), a = i(4), s = function (t) {
                ...
                var _ = function (e, i, n, r) {
                    ...
                    if (t.getTaskType(l.type) == a.types.milestone ? s.push("gantt_milestone") : t.getTaskType(l.type) == a.types.project && s.push("gantt_project"), s.push("gantt_bar_" + t.getTaskType(l.type)), t.isSummaryTask(l) && s.push("gantt_dependent_task"), t.isSplitTask(l) && s.push("gantt_split_parent"), a.select_task && n == o.selected_task && s.push("gantt_selected"), n == o.drag_id && (s.push("gantt_drag_" + o.drag_mode), o.touch_drag && s.push("gantt_touch_" + o.drag_mode)), o.link_source_id == n && s.push("gantt_link_source"), o.link_target_id == n && s.push("gantt_link_target"), a.highlight_critical_path && t.isCriticalTask && t.isCriticalTask(l) && s.push("gantt_critical_task"), o.link_landing_area && o.link_target_id && o.link_source_id && o.link_target_id != o.link_source_id) {
                        var c = o.link_source_id, d = o.link_from_start, h = o.link_to_start,
                            u = t.isLinkAllowed(c, n, d, h), f = "";
                        f = u ? h ? "link_start_allow" : "link_finish_allow" : h ? "link_start_deny" : "link_finish_deny", s.push(f)
                    }
                    return s.join(" ")
    ...
    var n = i(0), r = i(31), a = i(12), s = i(2), o = function (t) {
        function e(e, i, n, r) {
    ...
    var n = i(30), r = i(4), a = i(0), s = i(29), o = i(120), l = function (t, e, i, s) {
    ...
    l.prototype = {
        init: function (t) {
            ...
            for (var u = d; u < h && t.trace_x[u]; u++) {
                ...
                var f = o.call(this, s), g = t.width[u], _ = t.height, p = t.left[u], v = "", m = "", y = "";
                if (g) {
                    v = "width:" + g + "px;height:" + _ + "px;" + (n.smart_scales ? "position:absolute;left:" + p + "px" : ""), y = "gantt_scale_cell" + (u == t.count - 1 ? " gantt_last_cell" : ""), (m = l.call(this, s)) && (y += " " + m);
            ...
            (i = []).push([t.$container, n[0], function (i) {
                ...
                if (!a(i)) {
                    ...
                    if (s && s.on_mouse_up(n), u && (t.refreshTask(t.locate(u)), u.parentNode && (u.parentNode.removeChild(u), t._touch_feedback())), t._touch_scroll_active = l = c = !1, u = null, d && o) {
                        var f = new Date;
                        if (f - o < 500) t.$services.getService("mouseEvents").onDoubleClick(d), g(i); else o = f
                    } else o = new Date
                }
            }]);
    ...
    var n = i(3), r = i(1), a = i(20), s = i(2);
    t.exports = function (t) {
        var e = i(5)(t), o = {resources: {}, resourcesValues: {}, filter: {}, eventsInitialized: {}};
        ...
        return t.attachEvent("onAfterLightbox", function () {
            for (var t in o.filter) o.filter[t].checkbox.checked = !1, o.filter[t].input.value = "", o.filter[t].filterApplied = !1;
            o.resourcesValues = {}
        }), s(l, e), l.prototype.render = function (t) {
            var e;
            return e = "<div" + (isNaN(t.height) ? "" : " style='height: " + t.height + "px;'") + ">", e += "<div class='gantt_cal_ltext gantt_resources_filter'><input type='text' class='gantt_resources_filter_input' placeholder='type to filter'> <label><input class='switch_unsetted' type='checkbox'><span class='matherial_checkbox_icon'></span>hide empty</label></div>", e += "<div class='gantt_cal_ltext gantt_resources' data-name='" + t.name + "'></div>", e += "</div>"
            ...
            !function (t, e) {
                if (!o.filter[e.id]) {
                    var i = t.querySelector(".gantt_resources_filter"),
                        n = i.querySelector(".gantt_resources_filter_input"), r = i.querySelector(".switch_unsetted");
                    o.filter[e.id] = {container: i, input: n, checkbox: r, filterApplied: !1}
                }
                o.filter[e.id]
            }(e, l), function (e, i, a, s) {
                if (o.eventsInitialized[a.id]) return;
                var l = function (r) {
                    var l, c, d, u, f, g = i[a.map_to], _ = h(a);
                    f = _.checkbox, u = _.input, d = f.checked, c = function (t) {
                        return t.value.trim()
                    }(u), l = function (e, i, r, a) {
                        var s, l;
                        if (a) {
                            var c = i[e.map_to] || [];
                            if (n.isArray(c) || (c = [c]), 0 === (c = c.slice()).length) {
                                for (var d in c = [], (l = t.copy(e)).options = [], o.resourcesValues[e.id]) c.push({
                                    resource_id: d,
                                    value: o.resourcesValues[e.id][d]
                                });
                                if (0 === c.length) return l
                            } else for (var d in o.resourcesValues[e.id]) {
                                var h = n.arrayFind(c, function (t) {
                                    return t.id == d
                                });
                                h || c.push({resource_id: d, value: o.resourcesValues[e.id][d]})
                            }
                            for (var u = {}, f = 0; f < c.length; f++) u[c[f].resource_id] = !0;
                            s = function (t) {
                                if (u[String(t.key)] && ("" === r || t.label.indexOf(r) >= 0)) return t
                            }
                        } else {
                            if ("" === r) return e;
                            s = function (t) {
                        ...
                        return (l = t.copy(e)).options = n.arrayFilter(l.options, s), l
                    }(a, i, c, d), _.filterApplied = !0, s.form_blocks.resources.set_value(e, g, i, l)
                };

                function u(e) {
                    var i, n, s = e.target;
                    if ("checkbox" === e.target.type) {
                        i = s.parentNode, (n = i.querySelector(c())).disabled = !s.checked;
                        var l = n.getAttribute("data-item-id"), d = r.locateClassName(e, "gantt_resource_row"),
                            h = d.querySelector(".gantt_resource_amount_input");
                        if (d.setAttribute("data-checked", s.checked), s.checked) {
                            "select" === n.nodeName.toLowerCase() && t.callEvent("onResourcesSelectActivated", [{target: n}]);
                            var u = l, g = a.default_value;
                            a.options.forEach(function (t) {
                                t.key == u && t.default_value && (g = t.default_value)
                            }), h && !h.value && void 0 !== g && (h.value = g, f(a, this)), h.select ? h.select() : h.focus && h.focus()
                        } else o.resourcesValues[a.id] && delete o.resourcesValues[a.id][l]
                    } else "text" !== e.target.type && "select" !== e.target.nodeName.toLowerCase() || (i = s.parentNode.parentNode, n = e.target, f(a, this))
                }
                ...
                l = n.throttle(l, 100), h(a).container.addEventListener("keyup", l), h(a).container.addEventListener("input", l, !0), h(a).container.addEventListener("change", l, !0), d(a).addEventListener("input", u), d(a).addEventListener("change", u), t.attachEvent("onResourcesSelectActivated", t.bind(u, d(a))), o.eventsInitialized[a.id] = !0
            }(e, s, l, this), n.forEach(l.options, function (t, e) {
            ...
            var r = d(i), a = [], s = c(!0), l = c(!1), u = h(i), f = e[i.map_to] || [], g = {};
            u.filterApplied && f && f.length > 0 && n.forEach(f, function (t) {
                g[String(t.resource_id)] = t
            });
            for (var _ = r.querySelectorAll(s), p = r.querySelectorAll(l), v = 0; v < p.length; v++) delete g[p[v].getAttribute("data-item-id")];
            for (v = 0; v < _.length; v++) {
                var m = _[v].getAttribute("data-item-id"), y = _[v].value.trim();
                "" !== y && "0" !== y && (delete g[m], a[a.length] = {resource_id: m, value: y})
            }
            for (var k in g) o.resourcesValues[i.id] ? a[a.length] = o.resourcesValues[i.id][k] || g[k] : a[a.length] = g[k];
            return a
    ...
    t.exports = function (t) {
        ...
        return n(r, e), r.prototype.render = function (e) {
            ...
            var o, l, c, d, h = r, u = e.getElementsByTagName("select"), f = e.getElementsByTagName("input"), g = f[1],
                _ = [f[0], f[2]], p = e.getElementsByTagName("span")[0], v = r._time_format_order;
            ...
            _[0].onclick = t.bind(function () {
                ...
                y(1 * t.config.duration_step)
            }, this), u[0].onchange = m, u[1].onchange = m, u[2].onchange = m, u[3] && (u[3].onchange = m), g.onkeydown = t.bind(function (e) {
                var i;
            ...
            }, this), g.onchange = t.bind(m, this), "string" == typeof(o = t._resolve_default_mapping(r)) && (o = {start_date: o}), l = n[o.start_date] || new Date, c = n[o.end_date] || t.calculateEndDate({
                start_date: l,
                duration: 1,
                task: n
                ...
                end_date: c,
                task: n
            }), t.form_blocks._fill_lightbox_select(u, 0, l, v, h), g.value = d, m()
    ...
    t.exports = function (t) {
        var e = i(1), n = i(3), r = i(58)(t), a = i(57)(t), s = i(56)(t), o = i(10)(t), l = i(55)(t), c = i(54)(t),
            d = i(53)(t), h = i(52)(t), u = i(51)(t);
    ...
    var n = i(66), r = i(63), a = i(61), s = i(0);
    t.exports = function (t) {
    ...
    var n = i(14);
    t.exports = function (t) {
        i(71)(t), n.prototype.getGridColumns = function () {
    ...
    function r(t) {
        ...
        function a(n, r, a, s) {
            ...
            return e[o] ? e[o] : e[o] = function (e, n, r, a) {
                ...
                for (var f, g, _, p = [], v = a.$getConfig(), l = 0; l < r.trace_x.length; l++) f = new Date(r.trace_x[l]), g = t.date.add(f, 1, s), ((_ = o[f.valueOf()] || []).length || v.resource_render_empty_cells) && p.push({
                    start_date: f,
                    end_date: g,
                    tasks: _
                });
        ...
        return t.$data.tasksStore.attachEvent("onStoreUpdated", function () {
            ...
            renderLine: function (t, e) {
                ...
                for (var n = i.$getConfig(), r = i.$getTemplates(), l = a(e, n.resource_property, i.getScale(), i), c = [], d = {}, h = e.capacity || i.$config.capacity || 24, u = 0; u < l.length; u++) {
                    var f = l[u], g = r.histogram_cell_class(f.start_date, f.end_date, e, f.tasks),
    ...
    t.exports = function (t) {
        ...
        function _() {
            ...
            l && !_ ? l = 0 : l < 0 && !g ? l = 0 : l > 0 && g + _ >= v + 2 && (l = 0), s && !y ? s = 0 : s < 0 && !m ? s = 0 : s > 0 && m + y >= k && (s = 0);
    ...
    t.exports = function (t) {
        for (var e = [i(81), i(80), i(79), i(78), i(77), i(76), i(75), i(74)], n = 0; n < e.length; n++) e[n] && e[n](t)
    }
}, function (t, e, i) {
    ...
    var n = i(0), r = i(89), a = i(88), s = i(26), o = i(24), l = i(87), c = i(86);
    ...
    var n = i(1), r = function (t, e) {
        ...
        u.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
            ...
            if (n.locateClassName(a, "gantt_link_point")) {
                ...
                return this._dir_start = f(c, !!o, 0, t.$getConfig(), !0), !0
            }
            return !1
            ...
            if (n.isChildOf(o.target || o.srcElement, e.$root) || (h = !1, y = null), h && (k = !n.locateClassName(o, "task_end_date"), h = !!y), r = y, i = h, a = k, h) {
                ...
                x && (w = Math.floor(x.offsetWidth / 2)), this._dir_end = f(b, !!a, w, $)
            } else this._dir_end = n.getRelativeEventPosition(o, t.$task_data);
            var S = !(v == h && _ == y && m == k);
            return S && (_ && e.refreshTask(_, !1), y && e.refreshTask(y, !1)), S && g(c.marker), function (i, n, r, a) {
                var s = function () {
    ...
    var n = i(0), r = i(96), a = i(95), s = i(1), o = function (t) {
        var e = t.$services;
        return {
            onCreated: function (e) {
                var s = e.$config;
                s.bind = n.defined(s.bind) ? s.bind : "task", s.bindLinks = n.defined(s.bindLinks) ? s.bindLinks : "link", e._linksDnD = a.createLinkDND(), e._tasksDnD = r.createTaskDND(), e._tasksDnD.extend(e), this._mouseDelegates = i(13)(t)
            }, onInitialized: function (e) {
    ...
    var n = i(1), r = i(11), a = i(100), s = i(99), o = i(98);
    t.exports = {
        init: function (t, e) {
    ...
    var n = i(0), r = i(102), a = i(101), s = function (t) {
        return {
            onCreated: function (e) {
                e.$config = n.mixin(e.$config, {bind: "task"}), "grid" == e.$config.id && (this.extendGantt(e), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(e), t.ext.inlineEditors.init()), this._mouseDelegates = i(13)(t)
            }, onInitialized: function (e) {
                var i = e.$getConfig();
    ...
    t.exports = function (t) {
        return function (e, i) {
            ...
            for (var l = [], c = 0; c < r.length; c++) {
                ...
                "add" == g.name ? (h = "<div " + (y = t._waiAria.gridAddButtonAttrString(g)) + " class='gantt_add'></div>", u = "") : (h = g.template ? g.template(e) : e[g.name], n.isDate(h) && (h = s.date_grid(h, e)), u = h, h = "<div class='gantt_tree_content'>" + h + "</div>");
                var _ = "gantt_cell" + (f ? " gantt_last_cell" : ""), p = [];
                if (g.tree) {
                ...
                p.push(h), a.rtl && (p = p.reverse()), d = "<div class='" + _ + "' data-column-index='" + c + "' data-column-name='" + g.name + "' style='" + m + "' " + y + ">" + p.join("") + "</div>", l.push(d)
            }
        ...
        return function (e, i) {
            ...
            if (n.show_task_cells) for (var l = 0; l < s; l++) {
                ...
                if (c > 0) {
                    ...
                    h.style.width = c + "px", d = "gantt_task_cell" + (l == s - 1 ? " gantt_last_cell" : ""), (f = r.task_cell_class(e, a.trace_x[l])) && (d += " " + f), h.className = d, o.appendChild(h)
                }
            }
            var u = t.getGlobalTaskIndex(e.id) % 2 != 0, f = r.task_row_class(e.start_date, e.end_date, e),
    ...
    t.exports = function (t) {
        var e = i(7)(t), n = i(0), r = "%Y-%m-%d", a = null, s = null;
                ...
                switch (d) {
                    ...
                    default:
                        if (t.isVisible()) h = !0; else if (d >= 48 && d <= 57 || d > 95 && d < 112 || d >= 64 && d <= 91 || d > 185 && d < 193 || d > 218 && d < 223) {
                            ...
                            f.alt || g && a.getCommandHandler(e, "taskCell") || o && !t.isVisible() && (i.startEdit(s.id, s.columnName), h = !0)
                        }
                }
                return !h
            })
    ...
    var n = i(115), r = i(112), a = i(111), s = i(110), o = i(109), l = i(108), c = i(0), d = i(1), h = i(4);
    ...
    var n = i(0), r = i(28), a = i(12), s = i(2), o = function (t) {
        function e(e, i, n, r) {
            var a = t.apply(this, arguments) || this;
            return a.$config.bindLinks = null, a
        }
    ...
    var n = i(1), r = i(0), a = i(12), s = i(14), o = i(2), l = function (t) {
        function e(e, i, n, r) {
            ...
            init: function () {
                ...
                for (var i = e.getGridColumns(), n = e.$getConfig(), r = 0, a = e.$config.width, s = n.scale_height, o = 0; o < i.length; o++) {
                    ...
                    if (r += c.width, l = n.rtl ? a - r : r, c.resize) {
                        ...
                        d.className = "gantt_grid_column_resize_wrap", d.style.top = "0px", d.style.height = s + "px", d.innerHTML = "<div class='gantt_grid_column_resize'></div>", d.setAttribute(n.grid_resizer_column_attribute, o), t._waiAria.gridSeparatorAttr(d), e.$grid_scale.appendChild(d), d.style.left = Math.max(0, l) + "px"
                    }
                }
            }
        }
            ...
            render: function (t, i, r, d) {
                if (i.static_background && document.createElement("canvas").getContext) {
                    ...
                    var h = function (t, i, n, r) {
                        ...
                        for (var f = 0; f < c.length; f++) {
                            ...
                            if (g != s && void 0 !== s || f == c.length - 1 || l > h) {
                                for (var _ = r, p = 0, v = Math.floor(h / i.row_height) * i.row_height, m = l; _ > 0;) {
                                    var y = Math.min(_, v);
                                    _ -= v, (a = document.createElement("div")).style.height = y + "px", a.style.position = "absolute", a.style.top = p + "px", a.style.left = d + "px", a.style.whiteSpace = "no-wrap", a.className = t[s || g], f == c.length - 1 && (m = g + m - 1), a.style.width = m + "px", o.push(a), p += y
                                }
                                l = 0, d += m
                            }
                            g && (l += g, s = g)
                        ...
                        for (var f in d) {
                            var g = 1 * f, _ = s(g, h, t), p = a(_);
                            if (!p) {
                                var v = l(g, h, t);
                                o(_, v), u += "." + c(_) + "{ background-image: url('" + v + "');}"
                            }
                            r[f] = c(_)
                        }
                        if (u) {
    ...
    var n = i(2), r = i(32), a = i(6), s = function (t) {
        "use strict";
    ...
    var n = i(131), r = i(129), a = i(128), s = i(6), o = i(32), l = i(125), c = i(124), d = i(123), h = i(122),
        u = i(31), f = i(14), g = i(118), _ = i(28), p = i(117), v = i(116), m = i(27), y = i(107), k = i(106),
        b = i(105), $ = i(104), x = i(103), w = i(97), S = i(94);
    t.exports = {
        init: function (t) {
            function e(e, i) {
                var n = i(t);
    ...
    t.exports = function (t) {
        ...
        function d(r, d, h) {
            ...
            return "top" == r.position ? u.style.top = "-3px" : u.style.top = g + "px", u.style.left = f + "px", u.onkeydown = s, _.focus(u), r.hidden && _.hide(u), t.callEvent("onMessagePopup", [u]), u
        }
    ...
    i(16), t.exports = function () {
        var t = new function () {
            this.constants = i(143), this.version = "6.0.7", this.templates = {}, this.ext = {}, this.keys = {
                edit_save: this.constants.KEY_CODES.ENTER,
                edit_cancel: this.constants.KEY_CODES.ESC
            }
        };
        i(142)(t), t.$services = t.$inject(i(141)), t.config = t.$inject(i(140)), t.ajax = i(139)(t), t.date = i(138)(t);
        var e = i(137)(t);
        ...
        var a = i(0);
        a.mixin(t, a), t.env = i(8);
        var s = i(134)();
        t.event = s.attach, t.eventRemove = s.detach, t._eventRemoveAll = s.detachAll, t._createDomEventScope = s.extend, a.mixin(t, i(133)(t));
        var o = i(132).init(t);
        ...
        }), t.mixin(t, o.layersApi), i(93)(t), t.$services.setService("layers", function () {
            return o.layersService
        });
        var l = i(92);
        return t.mixin(t, l()), i(91)(t), i(85)(t), i(82)(t), i(73)(t), i(72)(t), i(70)(t), i(69)(t), i(68)(t), i(67)(t), i(60)(t), i(59)(t), i(50)(t), i(49)(t), i(47)(t), i(46)(t), i(45)(t), i(44)(t), i(43)(t), i(42)(t), i(41)(t), i(40)(t), i(39)(t), i(38)(t), i(17)(t), i(37)(t), i(35)(t), t
    }
}, function (t, e, i) {
    var n = {
        _seed: 0, plugin: function (t) {
            ...
            for (var t = i(144)(), e = 0; e < n._ganttPlugin.length; e++) n._ganttPlugin[e](t);
            return t._internal_id = n._seed++, n.$syncFactory && n.$syncFactory(t), i(34)(t), t
        }
    };
    t.exports = n
}, function (t, e, i) {
    ...
    var n = i(145), r = window;
    r.Gantt = n, r.gantt = n.getGanttInstance(), n.plugin(function (t) {
        ...
        -1 == document[e[1]][e[0]][e[3]](e[2]) && setTimeout(function () {
            t[e[6]]({type: e[4], text: e[5], expire: -1})
