...
dhtmlxGantt v.6.1.0 Professional Evaluation
...
!function (t, e) {
    ...
    return function (t) {
            ...
            return {
                init: function () {
                    ...
                    if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
                        ...
                        }, 300), o = "_attached_" + e.name;
                        t.$attachedResourceViewHandler || (t.$attachedResourceViewHandler = !0, i[o] = t.attachEvent("onStoreUpdated", a)), e.$attachedResourceViewHandler || (e.$attachedResourceViewHandler = e.attachEvent("onBeforeStoreUpdate", function () {
        ...
        var n = i(1), r = i(0), a = i(4), o = i(128), s = i(36), l = function (t, e, i, n) {
        ...
        l.prototype = {
            init: function (t) {
                ...
                var l = o(e, this);
                l.init(), this._renderHeaderResizers = l.doOnRender, this._mouseDelegates = i(17)(e), this._addLayers(this.$gantt), this._initEvents(), this.callEvent("onReady", [])
        ...
        (function (t) {
            ...
            }, i(22), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
        }).call(this, i(6))
    }, function (t, e, i) {
        (function (e, i, n) {
            t.exports = function () {
                    ...
                    1: [function (t, e, i) {
                        ...
                        i.exports = function (i, n) {
                            ...
                            i.longStackTraces = function () {
                                ...
                                if (!Z.longStackTraces && Y()) {
                                    ...
                                    }, i.prototype._captureStackTrace = z, i.prototype._attachExtraTrace = R, i.prototype._dereferenceTrace = H, n.activateLongStackTraces(), l.disableTrampolineIfNecessary()
                                }
                            ...
                            i.config = function (t) {
                                ...
                                if ("cancellation" in t && t.cancellation && !Z.cancellation) {
                                    ...
                                    i.prototype._clearCancellationData = L, i.prototype._propagateFrom = N, i.prototype._onCancel = P, i.prototype._setOnCancel = M, i.prototype._attachCancellationCallback = I, i.prototype._execute = A, O = N, Z.cancellation = !0
                                }
                        ...
                        i.exports = function () {
                            ...
                            return D.prototype.toString = function () {
                                ...
                                var t = new D(p);
                                return {promise: t, resolve: A, reject: I}
                            }, c.notEnumerableProp(D, "_makeSelfResolutionError", n), t("./method")(D, p, y, a, x), t("./bind")(D, p, y, x), t("./cancel")(D, b, a, x), t("./direct_resolve")(D), t("./synchronous_inspection")(D), t("./join")(D, b, y, p, h, s), D.Promise = D, D.version = "3.5.3", t("./map.js")(D, b, a, y, p, x), t("./call_get.js")(D), t("./using.js")(D, a, y, w, p, x), t("./timers.js")(D, p, x), t("./generators.js")(D, a, p, y, o, x), t("./nodeify.js")(D), t("./promisify.js")(D, p), t("./props.js")(D, b, y, a), t("./race.js")(D, p, y, a), t("./reduce.js")(D, b, a, y, p, x), t("./settle.js")(D, b, x), t("./some.js")(D, b, a), t("./filter.js")(D, p), t("./each.js")(D, p), t("./any.js")(D), c.toFastProperties(D), c.toFastProperties(D.prototype), P({a: 1}), P({b: 2}), P({c: 3}), P(1), P(function () {
                        ...
                        var j = void 0 !== e && "[object process]" === M(e).toLowerCase(),
        ...
        }).call(this, i(9), i(6), i(23).setImmediate)
    }, , , , function (t, e, i) {
        var n = i(0), r = i(3);
        ...
        var n = i(32), r = i(0), a = i(33), o = function (t) {
        ...
        var n = i(32), r = i(0), a = i(4), o = function (t) {
        ...
        var n = i(37), r = i(4), a = i(0), o = i(36), s = i(129), l = function (t, e, i, o) {
        ...
        l.prototype = {
            init: function (t) {
                ...
                for (var a = c(i, e), o = +i[a]; n[o];) o = +i[++a];
                var s = this._tasks.trace_index_transition, l = a;
                if (!o) return s ? s[0] : 0;
                var u = (t - i[a]) / this._getColumnDuration(this._tasks, i[a]);
                return s ? s[l] + (1 - u) : l + u
        ...
        t.exports = function (t) {
            var e = i(30);
            t.assert = i(43)(t), t.init = function (t, e, i) {
        ...
        t.exports = function (t) {
            ...
            return n(r, e), r.prototype.render = function (i) {
                var n = t.config.types, r = t.locale.labels, a = [], o = i.filter || function () {
                    return !0
                };
        ...
        t.exports = function (t) {
            ...
            return t.attachEvent("onAfterLightbox", function () {
                ...
                s.resourcesValues = {}
            }), o(l, e), l.prototype.render = function (t) {
                var e;
        ...
        t.exports = function (t) {
            var e = i(1), n = i(3), r = i(66)(t), a = i(65)(t), o = i(64)(t), s = i(14)(t), l = i(63)(t), c = i(62)(t),
                u = i(61)(t), d = i(60)(t), h = i(59)(t), f = i(58)(t);
        ...
        a.prototype = {
            units: ["year", "month", "week", "day", "hour", "minute"], _getUnitOrder: function (t) {
                ...
                var l = this.$gantt.date.day_start(new Date(a)), c = a,
                    ...
                    h = this._getWorkHoursForRange(s, l);
                return h = h / n + u + d
                ...
                for (n = n || 1, e = Math.abs(1 * e); a < e;) {
                    var o = this._nextDate(r, i, n);
                    this._isWorkTime(n > 0 ? new Date(o.valueOf() - 1) : new Date(o.valueOf() + 1), i) && a++, r = o
                }
                return r
                ...
                var e = t.unit, i = this.$gantt.date[e + "_start"](new Date(t.date)), n = new Date(i), r = new Date(i),
                    a = !0, o = 0, s = "any" == t.dir || !t.dir, l = 1;
                "past" == t.dir && (l = -1);
                for (var c = this._getUnitOrder(e), u = this.units[c - 1]; !this._isWorkTime(i, e);) {
                    if (u && !this._isWorkTime(i, u)) {
                        var d = this.$gantt.copy(t);
                        return d.date = i, d.unit = u, this._getClosestWorkTime(d)
                    }
                    s && (i = a ? n : r, l *= -1);
                    var h = i.getTimezoneOffset();
                    if (i = this.$gantt.date.add(i, l, e), i = this.$gantt._correct_dst_change(i, h, l, e), this.$gantt.date[e + "_start"] && (i = this.$gantt.date[e + "_start"](i)), s && (a ? n = i : r = i), a = !a, ++o > 3e3) return this.$gantt.assert(!1, "Invalid working time check"), !1
                }
                return i != r && "past" != t.dir || (i = this.$gantt.date.add(i, 1, e)), i
            }
        }, t.exports = a
    }, function (t, e, i) {
        var n = i(0), r = i(28), a = i(73);
        ...
        var n = i(74), r = i(71), a = i(69), o = i(0);
        t.exports = function (t) {
        ...
        var n = i(3), r = function () {
            ...
            return t.prototype.attach = function () {
                var t = this.$dp, e = this.$gantt, n = i(29), r = {};
                ...
                this._dataProcessorHandlers.push(e.attachEvent("onTaskIdChange", function (i, n) {
                    ...
                    } else this.serverProcessor = t + e.ajax.urlSeparator(t) + "gantt_mode=" + this._ganttMode;
                    return !0
        ...
        var n = i(0), r = i(98), a = i(97), o = i(33), s = i(31), l = i(96), c = i(95);
        ...
        var n = i(0), r = i(105), a = i(104), o = i(1), s = function (t) {
            ...
            return {
                onCreated: function (e) {
                    var o = e.$config;
                    o.bind = n.defined(o.bind) ? o.bind : "task", o.bindLinks = n.defined(o.bindLinks) ? o.bindLinks : "link", e._linksDnD = a.createLinkDND(), e._tasksDnD = r.createTaskDND(), e._tasksDnD.extend(e), this._mouseDelegates = i(17)(t)
                }, onInitialized: function (e) {
        ...
        var n = i(1), r = i(15), a = i(109), o = i(108), s = i(107);
        t.exports = {
            init: function (t, e) {
                ...
                if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                    ...
                    t.defined(e.$getConfig().dnd_sensitivity) && (l.config.sensitivity = e.$getConfig().dnd_sensitivity), l.attachEvent("onBeforeDragStart", t.bind(function (i, n) {
                        ...
                        var a = r.getAttribute(e.$config.item_attribute), o = e.$config.rowStore.getItem(a);
                        return !t.isReadonly(o) && (l.config.initial_open_state = o.$open, !!t.callEvent("onRowDragStart", [a, n.target || n.srcElement, n]) && void 0)
            ...
            init: function (t, e) {
                ...
                if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                    ...
                    t.defined(e.$getConfig().dnd_sensitivity) && (r.config.sensitivity = e.$getConfig().dnd_sensitivity), r.attachEvent("onBeforeDragStart", t.bind(function (i, n) {
                        ...
                        if (!s) return !1;
                        t.hideQuickInfo && t._hideQuickInfo();
                        var l = s.getAttribute(e.$config.item_attribute), c = o().getItem(l);
        ...
        var n = i(0), r = i(111), a = i(110), o = function (t) {
            return {
                onCreated: function (e) {
                    e.$config = n.mixin(e.$config, {bind: "task"}), "grid" == e.$config.id && (this.extendGantt(e), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(e), t.ext.inlineEditors.init()), this._mouseDelegates = i(17)(t)
                }, onInitialized: function (e) {
                    var i = e.$getConfig();
        ...
        t.exports = function (t) {
            var e = i(8)(t), n = i(0), r = "%Y-%m-%d", a = null, o = null;
                ...
                init: h, createEditors: function (n) {
                    ...
                    var a = [], o = null, s = {
                        ...
                        startEdit: function (t, e) {
                            if (this.isVisible() && this.save(), o.exists(t)) {
        ...
        var n = i(0), r = i(35), a = i(16), o = i(2), s = function (t) {
            function e(e, i, n, r) {
                var a = t.apply(this, arguments) || this;
                return a.$config.bindLinks = null, a
            }
        ...
        var n = i(1), r = i(0), a = i(16), o = i(18), s = i(2), l = function (t) {
            function e(e, i, n, r) {
        ...
        var n = i(0), r = i(10), a = function (t, e) {
        ...
        var n = i(2), r = i(1), a = i(0), o = i(10), s = function (t) {
            "use strict";
        ...
        var n = i(2), r = i(1), a = i(0), o = i(7), s = function (t) {
            "use strict";
        ...
        var n = i(2), r = i(39), a = i(7), o = function (t) {
            "use strict";
        ...
        var n = i(140), r = i(138), a = i(137), o = i(7), s = i(39), l = i(134), c = i(133), u = i(132), d = i(131),
            h = i(38), f = i(18), _ = i(127), g = i(35), p = i(126), v = i(125), m = i(34), y = i(116), b = i(115),
        ...
        i(20), t.exports = function () {
            var t = new function () {
                this.constants = i(153), this.version = "6.1.0", this.templates = {}, this.ext = {}, this.keys = {
            ...
            t.mixin(t, c()), i(100)(t);
            var u = i(94);
            return t.dataProcessor = u.DEPRECATED_api, t.createDataProcessor = u.createDataProcessor, i(90)(t), i(81)(t), i(80)(t), i(78)(t), i(77)(t), i(76)(t), i(75)(t), i(68)(t), i(67)(t), i(57)(t), i(56)(t), i(54)(t), i(53)(t), i(52)(t), i(51)(t), i(50)(t), i(49)(t), i(48)(t), i(47)(t), i(46)(t), i(45)(t), i(21)(t), i(44)(t), i(42)(t), t
        }
    }, function (t, e, i) {
        var n = {
            _seed: 0, plugin: function (t) {
                ...
                for (var t = i(154)(), e = 0; e < n._ganttPlugin.length; e++) n._ganttPlugin[e](t);
                return t._internal_id = n._seed++, n.$syncFactory && n.$syncFactory(t), i(41)(t), t
            }
        };
        t.exports = n
    }, function (t, e, i) {
