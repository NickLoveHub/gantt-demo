...
!function (t) {
    ...
    var n = i(1), r = function (t, e) {
        ...
        u.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
            ...
            if (h && (k = !n.locateClassName(o, "task_end_date"), h = !!y), r = y, i = h, a = k, h) {
                var b = e.getTask(y), x = t.$getConfig(), $ = n.locateClassName(o, "gantt_link_control"), w = 0;
                $ && (w = Math.floor($.offsetWidth / 2)), this._dir_end = g(b, !!a, w, x)
    ...
    t.exports = function (t) {
        return function (e, i) {
            ...
            return b.style.height = x + "px", b.style.lineHeight = x + "px", a.smart_rendering && (b.style.position = "absolute", b.style.left = "0px", b.style.top = i.getItemTop(e.id) + "px"), i.$config.item_attribute && b.setAttribute(i.$config.item_attribute, e.id), t._waiAria.taskRowAttr(e, b), b.innerHTML = l.join(""), b
        }
    }
}, function (t, e) {
    t.exports = function (t) {
    ...
    t.exports = {
        init: function (t) {
            ...
            return t.ext.inlineEditors = E, t.ext._inlineEditors = E, E.init(t), {
                ...
                layersApi: T.init(),
                render: {gridLine: x(t), taskBg: k(t), taskBar: m(t), taskSplitBar: y(t), link: b(t)},
                layersService: {
                    getDataRender: function (e) {
    ...
    i(14), t.exports = function () {
        var t = new function () {
            this.constants = i(131), this.version = "6.0.4", this.templates = {}, this.ext = {}, this.keys = {
