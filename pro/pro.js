...
!function(t) {
            ...
            return {
                ...
                _linkToTaskStore: function() {
                    if (this.$config.rowStore && this.$gantt.$data.tasksStore) {
                        ...
                        var i = this
                            , a = n.delay(function() {
                            i.$gantt.getState().lightbox ? a() : e.refresh()
                        }, 300)
                            , s = "_attached_" + e.name;
                        t.$attachedResourceViewHandler || (t.$attachedResourceViewHandler = !0,
                            i[s] = t.attachEvent("onStoreUpdated", a)),
        ...
        l.prototype = {
            ...
            setSize: function(t, e) {
                this.$config.width = this.$state.width = t,
                    this.$state.height = e;
                for (var i, n = this.getGridColumns(), r = 0, a = 0, s = n.length; a < s; a++)
            ...
            scrollTo: function(t, e) {
                this.isVisible() && (1 * t == t && (this.$state.scrollLeft = this.$grid.scrollLeft = t),
                1 * e == e && (this.$state.scrollTop = this.$grid_data.scrollTop = e))
            },
            ...
            _setColumnsWidth: function(t, e) {
                ...
                for (s = e + 1; s < n.length; s++) {
                    ...
                    l < 0 ? d.min_width && d.width + h < d.min_width ? h = d.min_width - d.width : !d.min_width && i.min_grid_column_width && d.width + h < i.min_grid_column_width && (h = i.min_grid_column_width - d.width) : d.max_width && d.width + h > d.max_width && (h = d.max_width - d.width),
                        r -= d.width,
                        d.width += h,
                        l -= h
                }
                for (var u = l > 0 ? 1 : -1; l > 0 && 1 === u || l < 0 && -1 === u; ) {
                    ...
                    for (s = e + 1; s < n.length; s++) {
                        var g;
                        if ((g = n[s].width + u) == this._getColumnWidth(n[s], i, g) && (l -= u,
                                n[s].width = g),
                                !l)
                            break
                    }
                ...
                l && e > -1 && ((g = n[e].width + l) == this._getColumnWidth(n[e], i, g) && (n[e].width = g));
                ...
                if (t.autofit || n.length) {
                    ...
                    if (t.autofit)
                        for (a = 0; a < r.length; a++) {
                            ...
                            r[a] += c,
                            (d = this._getColumnWidth(e[a], t, r[a])) != r[a] && (c = d - r[a],
                                r[a] = d),
                                l -= c
                        }
                    else if (n.length)
                        for (a = 0; a < n.length; a++) {
                            ...
                            var d, h = n[a];
                            r[h] += c,
                            (d = this._getColumnWidth(e[h], t, r[h])) != r[h] && (c = d - r[h],
                                r[h] = d),
                                l -= c
                        }
                    for (a = 0; a < r.length; a++)
        ...
        t.exports = function(t) {
            return {
                ...
                getClosestWorkTimeArguments: function(e) {
                    var i, n = arguments[0];
                    return n instanceof s ? n : (i = r.isDate(n) ? new s(n) : new s(n.date,n.dir,n.unit,n.task,null,n.calendar),
                    n.id && (i.task = n),
                        i.dir = n.dir || "any",
                ...
                calculateEndDateArguments: function(e, i, n, a) {
                    var s, l = arguments[0];
                    return l instanceof o ? l : (s = r.isDate(l) ? new o(arguments[0],arguments[1],arguments[2],void 0,arguments[3],void 0,arguments[4]) : new o(l.start_date,l.duration,l.unit,l.step,l.task,null,l.calendar),
                    l.id && (s.task = l),
        ...
        s.prototype = r.mixin({
            ...
            _changeIdInner: function(t, e) {
                ...
                for (var s = 0; s < i.length; s++)
                    this.setParent(this.getItem(i[s]), e);
            ...
            _add_branch: function(t, e, i) {
                ...
                s || (1 * e == e ? a.splice(e, 0, t.id) : a.push(t.id),
                    t.$rendered_parent = r)
            },
        ...
        t.exports = function(t) {
            function e(e, a) {
                if (!t._isAllowedUnscheduledTask(e)) {
                    ...
                    d == o.types.milestone && o.link_line_width > 1 && (h += 1),
                    d == o.types.milestone && (s.left -= Math.round(c / 2),
                        s.width = c);
                    var u = document.createElement("div")
                        , f = Math.round(s.width);
                    a.$config.item_attribute && u.setAttribute(a.$config.item_attribute, e.id),
                    o.show_progress && d != o.types.milestone && function(e, i, n, r, a) {
                        var s = 1 * e.progress || 0;
                        n = Math.max(n - 2, 0);
                        var o = document.createElement("div")
                            , l = Math.round(n * s);
                        l = Math.min(n, l),
                        e.progressColor && (o.style.backgroundColor = e.progressColor,
                            o.style.opacity = 1),
                            o.style.width = l + "px",
                            o.className = "gantt_task_progress",
                            o.innerHTML = a.progress_text(e.start_date, e.end_date, e),
                        r.rtl && (o.style.position = "absolute",
                            o.style.right = "0px");
                    ...
                    e.textColor && (g.style.color = e.textColor),
                        u.appendChild(g);
                    var _ = function(e, i, n, r) {
                        ...
                        var o = t.getState()
                            , l = t.getTask(n);
                        if (t.getTaskType(l.type) == a.types.milestone ? s.push("gantt_milestone") : t.getTaskType(l.type) == a.types.project && s.push("gantt_project"),
                            ...
                            n == o.drag_id && (s.push("gantt_drag_" + o.drag_mode),
                            ...
                            var c = o.link_source_id
                                ...
                                , f = "";
                            f = u ? h ? "link_start_allow" : "link_finish_allow" : h ? "link_start_deny" : "link_finish_deny",
                                s.push(f)
                        }
                        return s.join(" ")
                    }("gantt_task_line", l.task_class(e.start_date, e.end_date, e), e.id, a);
                    (e.color || e.progressColor || e.textColor) && (_ += " gantt_task_inline_color"),
                        u.className = _;
                    ...
                    o.drag_links && o.show_links && r(u, "gantt_link_control", e, function(t) {
                        var e = document.createElement("div");
                        e.className = t,
            ...
            function r(e, i, n, r, a) {
                var s, o = t.getState();
                +n.start_date >= +o.min_date && ((s = r([i, a.rtl ? "task_right" : "task_left", "task_start_date"].join(" "))).setAttribute("data-bind-property", "start_date"),
                    e.appendChild(s)),
                +n.end_date <= +o.max_date && ((s = r([i, a.rtl ? "task_left" : "task_right", "task_end_date"].join(" "))).setAttribute("data-bind-property", "end_date"),
                    e.appendChild(s))
            }
            return function(i, n) {
                    ...
                    if (this.$config.rowStore) {
                        ...
                        if (e.getParent && e.exists(t) && e.exists(e.getParent(t))) {
                            ...
                            if (this.$gantt.isSplitTask(i))
                                return this.getRowTop(e.getIndexById(i.id))
                        }
    ...
    , function(t, e, i) {
        ...
        l.prototype = {
            ...
            scrollTo: function(t, e) {
                this.isVisible() && (1 * e === e && (this.$config.scrollTop = e,
            ...
            _attachLayers: function(t) {
                ...
                if (this.$config.bind) {
                    ...
                    for (var r = this.$config.layers, a = 0; r && a < r.length; a++) {
                        ...
                        c.expose && (this._taskRenderer = n.getLayer(s))
                    }
                ...
                if (this.$config.bindLinks) {
                    ...
                    for (a = 0; l && a < l.length; a++) {
                        ...
                        "string" == typeof c && (c = this.$gantt.$ui.layers[c]),
                            (c = l[a]).host = this;
                        var d = o.addLayer(c);
                        this._taskLayers.push(d),
                        l[a].expose && (this._linkRenderer = o.getLayer(d))
                    }
                }
            },
            ...
            _prepareScaleHtml: function(t, e, i) {
                ...
                var d = 0
                    , h = t.count;
                !n.smart_scales || isNaN(e) || isNaN(i) || (d = c(t.left, e),
                    h = c(t.left, i) + 1),
                    l = t.css || function() {}
                    ,
                ...
                for (var u = d; u < h && t.trace_x[u]; u++) {
                    ...
                    var f = o.call(this, s)
                        ...
                        , y = "";
                    if (g) {
                        v = "width:" + g + "px;height:" + _ + "px;" + (n.smart_scales ? "position:absolute;left:" + p + "px" : ""),
                            y = "gantt_scale_cell" + (u == t.count - 1 ? " gantt_last_cell" : ""),
                        (m = l.call(this, s)) && (y += " " + m);
            ...
            return n(e, t),
                ...
                e.prototype._resizeScrollbars = function(t, e) {
                    ...
                    for (var l = 0; l < e.length; l++)
                        t[(i = e[l]).$config.scroll] ? o(i) : i.shouldHide() ? o(i) : i.shouldShow() ? s(i) : i.isVisible() ? r.push(i) : a.push(i);
                    var c = {};
                    for (l = 0; l < r.length; l++)
                        r[l].$config.group && (c[r[l].$config.group] = !0);
                    for (l = 0; l < a.length; l++)
                        (i = a[l]).$config.group && c[i.$config.group] && s(i);
                    return n
                }
                ,
                ...
                e.prototype.getContentSize = function(t) {
                    for (var e, i, n, r = 0, a = 0, s = 0; s < this.$cells.length; s++)
                        (i = this.$cells[s]).$config.hidden || (e = i.getContentSize(t),
                ...
                e.prototype.getSize = function() {
                    ...
                    for (var e = 0, i = 0, n = 1e5, r = 0, a = 1e5, s = 0, o = 0; o < this.$cells.length; o++) {
                        ...
                        this.$cells[o].$config.hidden || (this._xLayout ? (!l.width && l.minWidth ? e += l.minWidth : e += l.width,
                            n += l.maxWidth,
                            i += l.minWidth,
                            r = Math.max(r, l.height),
                            a = Math.min(a, l.maxHeight),
                            s = Math.max(s, l.minHeight)) : (!l.height && l.minHeight ? r += l.minHeight : r += l.height,
                            a += l.maxHeight,
                            s += l.minHeight,
                ...
                e.prototype.setSize = function(e, i) {
                    ...
                    for (var s = 0; s < this._sizes.length; s++)
                        if (!(n = this.$cells[s]).$config.hidden) {
                            ...
                            s !== this.$cells.length - 1 && (l.style[c] = o + "px",
                                this._free -= o),
                                r = this._sizes[s],
                    ...
                    for (s = 0; s < this.$cells.length; s++)
                        if (!(n = this.$cells[s]).$config.hidden) {
                            ...
                            var u = void 0
                                , f = void 0;
                            this._xLayout ? (u = this._calcSize(r.width, r, !0),
                                f = i - 2 * a) : (u = e - 2 * a,
                ...
                t._reinit = function(i) {
                    ...
                    this.$root && (this.$root.innerHTML = ""),
                        ...
                        function(t) {
                            ...
                            i.className = "gantt_container_resize_watcher",
                                i.tabIndex = -1,
    ...
    , function(t, e) {
        t.exports = function(t) {
            ...
            t._touch_events = function(n, r, a) {
                for (var s, o = 0, l = !1, c = !1, d = null, h = null, u = null, f = 0; f < i.length; f++)
                ...
                (i = []).push([t.$container, n[0], function(i) {
                    ...
                    if (!a(i) && l) {
                        ...
                        if (n && (n.drag.id || n.drag.start_drag))
                            return n.on_mouse_move(u),
                            i.preventDefault && i.preventDefault(),
                                i.cancelBubble = !0,
                                !1;
                        if (!t._prevent_touch_scroll) {
                            if (u && d) {
                                var f = d.pageX - u.pageX
                                    , _ = d.pageY - u.pageY;
                                if (!c && (Math.abs(f) > 5 || Math.abs(_) > 5) && (t._touch_scroll_active = c = !0,
                                        o = 0,
                                        s = t.getScrollState()),
                                        c) {
                                    t.scrollTo(s.x + f, s.y + _);
                                    var p = t.getScrollState();
                                    if (s.x != p.x && _ > 2 * f || s.y != p.y && f > 2 * _)
                                        return g(i)
                                }
                            }
                            return g(i)
                    ...
                    i.push([this.$container, n[1], function(i) {
                        if (!a(i))
                            if (i.touches && i.touches.length > 1)
                                ...
                                d = r(i),
                                t._locate_css(d, "gantt_hor_scroll") || t._locate_css(d, "gantt_ver_scroll") || (l = !0);
                                var n = e();
                                h = setTimeout(function() {
                                    var e = t.locate(d);
                                    n && e && !t._locate_css(d, "gantt_link_control") && !t._locate_css(d, "gantt_grid_data") && (n.on_mouse_down(d),
                    ...
                    i.push([this.$container, n[2], function(i) {
                        if (!a(i)) {
                            ...
                            var n = r(i)
                                , s = e();
                            if (s && s.on_mouse_up(n),
                                u && (t.refreshTask(t.locate(u)),
                                ...
                                var f = new Date;
                                if (f - o < 500)
                                    t.$services.getService("mouseEvents").onDoubleClick(d),
                                        g(i);
                                else
                                    o = f
                            } else
    ...
    , function(t, e) {
        function i(t, e) {
            ...
            s._redefine_lightbox_buttons && (e.config.buttons_right = s._redefine_lightbox_buttons.buttons_right,
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t) {
            ...
            function d(t) {
                return o.resources[t.id]
            }
            function h(t) {
                return o.filter[t.id]
            }
            return t.attachEvent("onAfterLightbox", function() {
                for (var t in o.filter)
                    o.filter[t].checkbox.checked = !1,
                        o.filter[t].input.value = "",
                        o.filter[t].filterApplied = !1;
                o.resourcesValues = {}
            }),
                s(l, e),
                l.prototype.render = function(t) {
                    var e;
                    return e = "<div" + (isNaN(t.height) ? "" : " style='height: " + t.height + "px;'") + ">",
                        e += "<div class='gantt_cal_ltext gantt_resources_filter'><input type='text' class='gantt_resources_filter_input' placeholder='type to filter'> <label><input class='switch_unsetted' type='checkbox'><span class='matherial_checkbox_icon'></span>hide empty</label></div>",
                        e += "<div class='gantt_cal_ltext gantt_resources' data-name='" + t.name + "'></div>",
                        e += "</div>"
                }
                ,
                l.prototype.set_value = function(e, i, s, l) {
                    var u, f = function(t, e) {
                        o.resources[e.id] || (o.resources[e.id] = t.querySelector(".gantt_resources"));
                        return o.resources[e.id]
                    }(e, l), g = "";
                    !function(t, e) {
                        if (!o.filter[e.id]) {
                        ...
                        function(e, i, a, s) {
                            if (o.eventsInitialized[a.id])
                                return;
                            var l = function(r) {
                                var l, c, d, u, f, g = i[a.map_to], _ = h(a);
                                f = _.checkbox,
                                    u = _.input,
                                    d = f.checked,
                                    c = function(t) {
                                    ...
                                    l = function(e, i, r, a) {
                                        ...
                                        if (a) {
                                            ...
                                            if (n.isArray(c) || (c = [c]),
                                                ...
                                                for (var d in c = [],
                                                    (l = t.copy(e)).options = [],
                                                    o.resourcesValues[e.id])
                                                    c.push({
                                                        resource_id: d,
                                                        value: o.resourcesValues[e.id][d]
                                                    });
                                                if (0 === c.length)
                                                    return l
                                            } else
                                                for (var d in o.resourcesValues[e.id]) {
                                                    var h = n.arrayFind(c, function(t) {
                                                        return t.id == d
                                                    });
                                                    h || c.push({
                                                        resource_id: d,
                                            ...
                                            for (var u = {}, f = 0; f < c.length; f++)
                                                u[c[f].resource_id] = !0;
                                            s = function(t) {
                                                if (u[String(t.key)] && ("" === r || t.label.indexOf(r) >= 0))
                                                    return t
                                            }
                                        } else {
                                            if ("" === r)
                                                return e;
                                            s = function(t) {
                                                if (t.label.indexOf(r) >= 0)
                                                    return t
                                            }
                                        }
                                        return (l = t.copy(e)).options = n.arrayFilter(l.options, s),
                                            l
                                    }(a, i, c, d),
                                    _.filterApplied = !0,
                                    s.form_blocks.resources.set_value(e, g, i, l)
                            };
                            function u(e) {
                                var i, n, s = e.target;
                                if ("checkbox" === e.target.type) {
                                    i = s.parentNode,
                                        (n = i.querySelector(c())).disabled = !s.checked;
                                    var l = n.getAttribute("data-item-id")
                                        , d = r.locateClassName(e, "gantt_resource_row")
                                        , h = d.querySelector(".gantt_resource_amount_input");
                                    if (d.setAttribute("data-checked", s.checked),
                                            s.checked) {
                                        ...
                                        a.options.forEach(function(t) {
                                            t.key == u && t.default_value && (g = t.default_value)
                                        }),
                                        h && !h.value && void 0 !== g && (h.value = g,
                                            f(a, this)),
                                            h.select ? h.select() : h.focus && h.focus()
                                    } else
                                        o.resourcesValues[a.id] && delete o.resourcesValues[a.id][l]
                                } else
                                    "text" !== e.target.type && "select" !== e.target.nodeName.toLowerCase() || (i = s.parentNode.parentNode,
                                        n = e.target,
                                        f(a, this))
                            }
                            function f(t, e) {
                                ...
                                o.resourcesValues[t.id] = o.resourcesValues[t.id] || {};
                                for (var r = 0; r < n.length; r++) {
                                    var a = n[r].getAttribute("data-item-id");
                                    n[r].disabled ? delete o.resourcesValues[t.id][a] : o.resourcesValues[t.id][a] = n[r].value
                                }
                            }
                            l = n.throttle(l, 100),
                                h(a).container.addEventListener("keyup", l),
                                h(a).container.addEventListener("input", l, !0),
                                h(a).container.addEventListener("change", l, !0),
                                d(a).addEventListener("input", u),
                                d(a).addEventListener("change", u),
                                t.attachEvent("onResourcesSelectActivated", t.bind(u, d(a))),
                                o.eventsInitialized[a.id] = !0
                        }(e, s, l, this),
                        n.forEach(l.options, function(t, e) {
                            l.unassigned_value != t.key && (u = function(t, e, i) {
                                var r = {};
                                if (e) {
                                    var a;
                                ...
                                g += ["<label class='gantt_resource_row' data-item-id='" + t.key + "' data-checked=" + (u.value ? "true" : "false") + ">", "<input class='gantt_resource_toggle' type='checkbox'", u.value ? " checked='checked'" : "", "><div class='gantt_resource_cell gantt_resource_cell_checkbox'><span class='matherial_checkbox_icon'></span></div>", "<div class='gantt_resource_cell gantt_resource_cell_label'>", t.label, "</div>", "<div class='gantt_resource_cell gantt_resource_cell_value'>", function(t, e, i) {
                                    ...
                                    t.options ? r += a.getHtmlSelect(t.options, n, e) : (n[n.length] = {
                                        ...
                                        r += a.getHtmlInput(n));
                                    return r
                                }(t, u.value, !u.value), "</div>", "<div class='gantt_resource_cell gantt_resource_cell_unit'>", t.unit, "</div>", "</label>"].join(""))
                        }),
                        f.innerHTML = g,
                        f.style.zoom = "1",
                ...
                l.prototype.get_value = function(t, e, i) {
                    var r = d(i)
                        ...
                        , f = e[i.map_to] || []
                        , g = {};
                    u.filterApplied && f && f.length > 0 && n.forEach(f, function(t) {
                        g[String(t.resource_id)] = t
                    });
                    for (var _ = r.querySelectorAll(s), p = r.querySelectorAll(l), v = 0; v < p.length; v++)
                        delete g[p[v].getAttribute("data-item-id")];
                    for (v = 0; v < _.length; v++) {
                        var m = _[v].getAttribute("data-item-id")
                            , y = _[v].value.trim();
                        "" !== y && "0" !== y && (delete g[m],
                            a[a.length] = {
                                resource_id: m,
                    ...
                    for (var k in g)
                        o.resourcesValues[i.id] ? a[a.length] = o.resourcesValues[i.id][k] || g[k] : a[a.length] = g[k];
                    return a
                }
                ,
                ...
                e.allow_root && n.unshift({
                    ...
                    n = function(e, i, n) {
                        ...
                        for (var a = 0; a < e.length; a++) {
                            var s = e[a];
                            (s.id == n || t.isChildOf(s.id, n) || !1 === r(s.id, s)) && (e.splice(a, 1),
                                a--)
                        }
                        return e
                    }(n, e, i),
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t) {
            ...
            return n(r, e),
                ...
                ,
                r.prototype.set_value = function(e, i, n, r) {
                    var o, l, c, d, h = r, u = e.getElementsByTagName("select"), f = e.getElementsByTagName("input"), g = f[1], _ = [f[0], f[2]], p = e.getElementsByTagName("span")[0], v = r._time_format_order;
                    function m() {
                        var i = a.call(t, e, r)
                            , o = s.call(t, e, r)
            ...
            return n(r, e),
                ...
                r.prototype.set_value = function(e, i, n, r) {
                    ...
                    var h = n[d.start_date] || new Date
                        , u = n[d.end_date] || t.calculateEndDate({
                        start_date: h,
                        duration: 1,
                        task: n
                    });
                ...
                switch (n.timeFormat[i]) {
                    case "%Y":
                        for (e._time_format_order[2] = i,
                             ...
                             e.year_range && (isNaN(e.year_range) ? e.year_range.push && (s = e.year_range[0],
                                 o = e.year_range[1]) : r = e.year_range),
                                 r = r || 10,
                                 a = a || Math.floor(r / 2),
                    ...
                    case "%m":
                        for (e._time_format_order[1] = i,
                                 e._time_format_order.size++,
                                 l = 0; l < 12; l++)
                            d += "<option value='" + l + "'>" + t.locale.date.month_full[l] + "</option>";
                        break;
                    case "%d":
                    ...
                    case "%H:%i":
                        for (e._time_format_order[3] = i,
                            ...
                            d += "<option value='" + l + "'>" + t.templates.time_picker(n.date) + "</option>",
            ...
            t._lightbox_methods = {},
                ...
                t.getLightbox = function(e) {
                    ...
                    n && (t.config.wide_form = !0,
                        s += " gantt_cal_light_full"),
                        i.className = s,
                        i.style.visibility = "hidden",
                        r = this._lightbox_template,
                        r += f(this.config.buttons_left),
                        r += f(this.config.buttons_right, !0),
                        i.innerHTML = r,
                    ...
                    t.config.drag_lightbox && (i.firstChild.onmousedown = t._ready_to_dnd,
                        ...
                        function(e) {
                            ...
                            for (o = 0; o < e.length; o++)
                                ...
                                (a = r.nextSibling) && (s = a.querySelector("input, select, textarea")) && (s.id = s.id || "input_" + t.uid(),
                                    i.inputId = s.id,
                    ...
                    t.lightbox_events = {},
                        ...
                        t.lightbox_events.default = function(i, n) {
                            if (n.getAttribute("data-dhx-button"))
                                ...
                                r && (r *= 1,
                                    t.form_blocks[o[1 * r].type].button_click(r, n, a, a.nextSibling))
                            }
                        }
                        ,
                ...
                t._set_lightbox_values = function(e, i) {
                    ...
                    for (var s = this._get_typed_lightbox_config(this.getLightboxType()), o = 0; o < s.length; o++) {
                        ...
                        if (this.form_blocks[l.type]) {
                            ...
                            d.set_value.call(t, c, u, n, l),
                            l.focus && d.focus.call(t, c)
                        }
                    }
                ...
                t.form_blocks = {
                    getTimePicker: function(e, i) {
                        ...
                        for (e._time_format_order = {
                            ...
                            r > 0 && (o += " "),
                            (a = g(e, r, c)) && (s = t._waiAria.lightboxSelectAttrString(c.timeFormat[r]),
                                o += "<select " + (e.readonly ? "disabled='disabled'" : "") + (i ? " style='display:none' " : "") + s + ">" + a + "</select>");
                        return o
                    },
        ...
        t.exports = function(t) {
            t.isUnscheduledTask = function(e) {
                ...
                t.roundDate = function(e) {
                    ...
                    if (!i)
                        return o;
                    if (c == i.unit && l == i.step && +o >= +i.min_date && +o <= +i.max_date)
                        ...
                        for (s = Math.floor(t.columnIndexByDate(o)),
                                 r = t.date[c + "_start"](new Date(i.min_date)),
                             i.trace_x[s] && (r = t.date[c + "_start"](i.trace_x[s])); +r < +o; ) {
    ...
    , function(t, e, i) {
        ...
        a.prototype = {
            ...
            _getWorkUnitsBetweenGeneric: function(t, e, i, n) {
                ...
                for (var f = !1; a.valueOf() < s.valueOf(); )
                    f = (d = this._nextDate(a, i, n)).valueOf() > s.valueOf(),
                    this._isWorkTime(a, i) && ((h || u && f) && (o = r[i + "_start"](new Date(a)),
                        l = r.add(o, n, i)),
                        h ? (h = !1,
                            d = this._nextDate(o, i, n),
                            c += (l.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf())) : u && f ? (u = !1,
                            c += (s.valueOf() - a.valueOf()) / (l.valueOf() - o.valueOf())) : c++),
                        a = d;
                return c
            },
            ...
            _isWorkTime: function(t, e, i) {
                ...
                return -1 == n && (n = this._checkIfWorkingUnit(t, e, i),
            ...
            _getClosestWorkTime: function(t) {
                ...
                for (var c = this._getUnitOrder(e), d = this.units[c - 1]; !this._isWorkTime(i, e); ) {
                    if (d && !this._isWorkTime(i, d)) {
                        ...
                        return h.date = i,
                            h.unit = d,
                            this._getClosestWorkTime(h)
                    }
                    o && (i = a ? n : r,
                        l *= -1);
                    var u = i.getTimezoneOffset();
                    if (i = this.$gantt.date.add(i, l, e),
                            i = this.$gantt._correct_dst_change(i, u, l, e),
                        this.$gantt.date[e + "_start"] && (i = this.$gantt.date[e + "_start"](i)),
                        o && (a ? n = i : r = i),
                            a = !a,
                        ++s > 3e3)
    ...
    , function(t, e, i) {
        ...
        s.prototype = {
            ...
            _getDayHoursForMultiple: function(t, e) {
                for (var i = [], n = !0, r = 0, a = this.$gantt.date.day_start(new Date(e)), s = 0; s < 24; s++)
            ...
            mergeCalendars: function() {
                ...
                for (var a = 0; a < n.length; a++)
                    for (var s in n[a].worktime.dates)
                        +s > 1e4 && (i = this._getDayHoursForMultiple(n, new Date(+s)),
            ...
            for (var s in t._waiAria = {
                ...
                _taskCommonAttr: function(e, i) {
                    ...
                    e.$dataprocessor_class && i.setAttribute("aria-busy", !0),
                        i.setAttribute("aria-selected", t.getState().selected_task == e.id || t.isSelectedTask && t.isSelectedTask(e.id) ? "true" : "false"))
                },
        ...
        t.exports = function(t) {
            ...
            t.attachEvent("onParse", e(function() {
                ...
                t.attachEvent("onAfterTaskMove", e(function(t, e, n) {
                    document.querySelector(".gantt_drag_marker") || (c(o),
                        i(t))
                }))
        }
    }
    ...
    , function(t, e, i) {
        ...
        function r(t) {
            ...
            function r(i, r) {
                for (var a, s = r.join("_") + "_" + i, o = {}, l = 0; l < r.length; l++)
                    o[r[l]] = !0;
                return e[s] ? a = e[s] : (a = e[s] = [],
                    t.eachTask(function(e) {
                        var r;
                        e.type != t.config.types.project && (r = n.isArray(e[i]) ? e[i] : [e[i]],
            ...
            function a(n, r, a, s) {
                ...
                return e[o] ? e[o] : e[o] = function(e, n, r, a) {
                    ...
                    for (var s = r.unit, o = {}, l = 0; l < _.length; l++)
                        for (var c = _[l], d = t.date[s + "_start"](new Date(c.start_date)); d < c.end_date; ) {
                            var h = d;
                            if (d = t.date.add(d, 1, s),
                                    t.isWorkTime({
                                        date: h,
                                        task: c,
                                        unit: s
                    ...
                    for (var f, g, _, p = [], v = a.$getConfig(), l = 0; l < r.trace_x.length; l++)
                        f = new Date(r.trace_x[l]),
                            g = t.date.add(f, 1, s),
                        ((_ = o[f.valueOf()] || []).length || v.resource_render_empty_cells) && p.push({
                            start_date: f,
                            end_date: g,
                            tasks: _
                        });
            ...
            }),
                {
                    renderLine: function(t, e) {
                        for (var i = e.$getConfig(), n = e.$getTemplates(), r = a(t, i.resource_property, e.getScale(), e), s = [], o = 0; o < r.length; o++) {
                            ...
                            if (c || d) {
                                ...
                                u.className = ["gantt_resource_marker", c].join(" "),
                    ...
                    renderHistogram: function(e, i) {
                        for (var n = i.$getConfig(), r = i.$getTemplates(), l = a(e, n.resource_property, i.getScale(), i), c = [], d = {}, h = e.capacity || i.$config.capacity || 24, u = 0; u < l.length; u++) {
                            var f = l[u]
                                , g = r.histogram_cell_class(f.start_date, f.end_date, e, f.tasks)
                                , _ = r.histogram_cell_label(f.start_date, f.end_date, e, f.tasks)
                            ...
                            if (d[f.start_date.valueOf()] = v || 0,
                                g || _) {
                                var m = i.getItemPosition(e, f.start_date, f.end_date)
                                    , y = document.createElement("div");
                                y.className = ["gantt_histogram_cell", g].join(" "),
                                    y.style.cssText = ["left:" + m.left + "px", "width:" + m.width + "px", "height:" + (n.row_height - 1) + "px", "line-height:" + (n.row_height - 1) + "px", "top:" + (m.top + 1) + "px"].join(";"),
                                _ && (_ = "<div class='gantt_histogram_label'>" + _ + "</div>"),
                                p && (_ = "<div class='gantt_histogram_fill' style='height:" + 100 * Math.min(p / h || 0, 1) + "%;'></div>" + _),
                                _ && (y.innerHTML = _),
                                    c.push(y)
                            }
                        }
                        var k = null;
                        if (c.length) {
                            for (k = document.createElement("div"),
                                     u = 0; u < c.length; u++)
                                k.appendChild(c[u]);
                            var b = function(e, i, n) {
                                for (var r = i.getScale(), a = document.createElement("div"), l = 0; l < r.trace_x.length; l++) {
                                    ...
                                    if (u < 0)
                                        return null;
                                    var f = Math.min(e[d.valueOf()] / n, 1) || 0
                                        , g = s(u, c, d, i);
                                    g && a.appendChild(g);
                            ...
                            b && (b.setAttribute("data-resource-id", e.id),
                                b.style.position = "absolute",
                                b.style.top = m.top + 1 + "px",
                                b.style.height = n.row_height - 1 + "px",
                                b.style.left = 0,
                                k.appendChild(b))
                        }
                        return k
                ...
                function(t, e) {
                    if (i)
                        ...
                        for (var d in function(t) {
                            ...
                            a.call(this),
                            l)
                            this.resetProjectDates(l[d]);
                        i = !1,
                        e || this.render(),
                        o && (this._dp.setUpdateMode(r),
        ...
        t.exports = function(t) {
            ...
            function _() {
                ...
                var e = n.getNodePosition(t.$task || t.$grid || t.$root)
                    ...
                    , y = u.inner_width
                    , k = u.width;
                l && !_ ? l = 0 : l < 0 && !g ? l = 0 : l > 0 && g + _ >= v + 2 && (l = 0),
                    s && !y ? s = 0 : s < 0 && !m ? s = 0 : s > 0 && m + y >= k && (s = 0);
    ...
    , function(t, e, i) {
        t.exports = function(t) {
            for (var e = [i(81), i(80), i(79), i(78), i(77), i(76), i(75), i(74)], n = 0; n < e.length; n++)
                e[n] && e[n](t)
        }
    }
    , function(t, e, i) {
        ...
        a.prototype = {
            setTransactionMode: function(t, e) {
                ...
                n.defined(t.payload) && (this._payload = t.payload)) : (this._tMode = t,
                    this._tSend = e),
                "REST" == this._tMode && (this._tSend = !1,
                    this._endnm = !0),
                "JSON" != this._tMode && "REST-JSON" != this._tMode || (this._tSend = !1,
                    this._endnm = !0,
                    this._serialize_as_json = !0,
            ...
            serialize: function(t, e) {
                ...
                var i = []
                    , n = [];
                for (var r in t)
                    t.hasOwnProperty(r) && (i.push(this.serialize_one(t[r], r + this.post_delim)),
                        n.push(r));
                ...
                if (t) {
                    ...
                    switch (this._tMode) {
                        ...
                        case "JSON":
                            var o = {};
                            for (var l in t)
                                l !== this.action_param && "id" !== l && "gr_id" !== l && (o[l] = t[l]);
                            r.url = s,
                                r.method = "POST",
                        ...
                        this._forEachUpdatedRow(function(t) {
                            if (!e && !this._in_progress[t]) {
                                if (this.is_invalid(t))
                                    return;
                                this._beforeSendData(this._getRowData(t), t),
                                this._waitMode && ("tree" == this.obj.mytype || this.obj._h2) && (e = !0)
                            }
                        })
                    }
                }
            ...
            _getAllData: function(t) {
                ...
                return this._forEachUpdatedRow(function(t) {
                    if (!this._in_progress[t] && !this.is_invalid(t)) {
                        ...
                        this.callEvent("onBeforeUpdate", [t, this.getState(t), n]) && (e[t] = n,
                            i = !0,
                            this._in_progress[t] = (new Date).valueOf())
                    }
                }),
                    i ? e : null
            },
            ...
            afterUpdateCallback: function(t, e, i, n) {
                ...
                "wait" != this._in_progress[r] ? (a && this.obj.setUserData(t, this.action_param, ""),
    ...
    , function(t, e, i) {
                ...
                for (var r in i) {
                    ...
                    switch (r) {
                        ...
                        case "end_date":
                            ...
                            break;
                        case "duration":
                            n.end_date = this.calculateEndDate({
        ...
        function a(t, e, i, n) {
            ...
            "links" == n && (a.add = this.addLink,
                a.isExist = this.isLinkExists),
            a.isExist.call(this, e) || (r.id = e,
                a.add.call(this, r))
        }
        function s(t, e, i, n) {
            var r = {
            ...
            "links" == n && (r.delete = this.deleteLink,
                r.isExist = this.isLinkExists),
            r.isExist.call(this, e) && r.delete.call(this, e)
        }
        t.exports = function(t, e) {
            e.attachEvent("insertCallback", n.bind(a, t)),
                e.attachEvent("updateCallback", n.bind(r, t)),
                e.attachEvent("deleteCallback", n.bind(s, t))
        }
    }
    , function(t, e, i) {
        var n = i(84)
        ...
        t.exports = function(t) {
            var e;
            t.dataProcessor = i(83);
            var a = [];
            t._dp_init = function(s) {
                t.assert(!this._dp, "The dataProcessor is already attached to this gantt instance"),
                    s.setTransactionMode("POST", !0),
                    s.serverProcessor += (-1 != s.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true",
                    s._serverProcessor = s.serverProcessor,
                    s.$gantt = this,
                    s.styles = {
                    ...
                    s._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"],
                    function(t, i) {
                        i.setGanttMode = function(t) {
                            ...
                            i.afterUpdate = function() {
                                ...
                                var n = i._ganttMode
                                    , r = t.filePath;
                                n = "REST" != this._tMode && "REST-JSON" != this._tMode ? -1 != r.indexOf("gantt_mode=links") ? "links" : "tasks" : r.indexOf("/link") > r.indexOf("/task") ? "links" : "tasks",
                                    i.setGanttMode(n);
                            ...
                            i._getRowData = t.bind(function(e, n) {
                                ...
                                return c.$no_start && (a.start_date = "",
                                    a.duration = ""),
                                c.$no_end && (a.end_date = "",
                                    a.duration = ""),
                    ...
                    function(t, e) {
                        t._change_id = t.bind(function(t, i) {
                            ...
                            t._row_style = function(i, n) {
                                "tasks" == e._ganttMode && t.isTaskExists(i) && (t.getTask(i).$dataprocessor_class = n,
                                    t.refreshTask(i))
                            }
                            ,
                    ...
                    function(t, e) {
                        function n(i) {
                            for (var n = e.updatedRows.slice(), r = !1, a = 0; a < n.length && !e._in_progress[i]; a++)
                                n[a] == i && ("inserted" == t.getUserData(i, "!nativeeditor_status") && (r = !0),
                                    e.setUpdated(i, !1));
                            return r
                        }
                        a.push(this.attachEvent("onAfterTaskAdd", function(i, n) {
                            t.isTaskExists(i) && (e.setGanttMode("tasks"),
                                e.setUpdated(i, !0, "inserted"))
                        })),
                        ...
                        a.push(this.attachEvent("onBeforeTaskDelete", function(e, i) {
                            ...
                            a.push(this.attachEvent("onAfterTaskDelete", function(i, r) {
                                if (e.setGanttMode("tasks"),
                                    ...
                                    if (t.config.cascade_delete && s[i]) {
                                        ...
                                        for (var l in e.setGanttMode("links"),
                                            o.links)
                                            n(l) || e.setUpdated(l, !0, "deleted");
                                        s[i] = null,
                                        "off" != a && e.sendAllData(),
                            ...
                            a.push(this.attachEvent("onAfterLinkUpdate", function(i, n) {
                                t.isLinkExists(i) && (e.setGanttMode("links"),
                                    e.setUpdated(i, !0))
                            })),
                    ...
                    n(t, s),
                    t.callEvent("onDataProcessorReady", [s])
            }
                ,
            ...
            bindDataStore: function(t, e) {
                ...
                i.attachEvent("onStoreUpdated", function(s, o, l) {
                    if (!a(e)) {
                        ...
                        c && (s && "move" != l && "delete" != l ? (i.callEvent("onBeforeRefreshItem", [o.id]),
                            n(o.id, c),
                            i.callEvent("onAfterRefreshItem", [o.id])) : (i.callEvent("onBeforeRefreshAll", []),
                            r(c),
                    ...
                    i.attachEvent("onIdChange", function(r, s) {
                        if (i.callEvent("onBeforeIdChange", [r, s]),
                                !a(e)) {
        ...
        var h = function() {
            return {
                ...
                refreshData: function() {
                    ...
                    for (var e = d.call(this), i = 0; i < e.length; i++)
                        e[i].refresh();
            ...
            return {
                ...
                scrollTo: function(t, e) {
                    ...
                    a && (c = a.getScrollState()),
                        this.callEvent("onGanttScroll", [s.position, o.position, c.position, l.position])
                },
                showDate: function(t) {
                ...
                _scroll_state: function() {
                    ...
                    if (e) {
                        ...
                        s.visible && (t.y = s.size,
                            t.y_inner = s.scrollSize),
                    ...
                    this._legacyGridResizerClass(e),
                        e.attachEvent("onBeforeResize", function() {
                            ...
                            if (a) {
                                ...
                                if (a.$config.hidden = a.$parent.$config.hidden = !s,
                                        !a.$config.hidden) {
                    ...
                    if (n.resizer) {
                        ...
                        s.attachEvent("onResizeStart", function(e, i) {
                            ...
                            s.attachEvent("onResizeEnd", function(e, i, n, r) {
                                ...
                                return d && (t.config.grid_width = o),
                                    d
                            })
                    }
                },
        ...
        var n = i(1)
            ...
            function f(i, n, r, a, s) {
                var o = function(i, n, r) {
                    ...
                    r.rtl ? (s.xEnd = s.x,
                        s.x = s.xEnd + s.width) : s.xEnd = s.x + s.width;
                    if (s.yEnd = s.y + s.height,
            ...
            u.attachEvent("onBeforeDragStart", e.bind(function(i, r) {
                ...
                if (n.locateClassName(a, "gantt_link_point")) {
                    ...
                    if (e.isReadonly(c))
                        return _(),
                            !1;
                    return this._dir_start = f(c, !!o, 0, t.$getConfig(), !0),
                        !0
                }
                return !1
            }, this)),
                ...
                u.attachEvent("onDragMove", e.bind(function(s, o) {
                    ...
                    var h = !!n.locateClassName(o, "gantt_link_control")
                        ...
                        , y = e.locate(o)
                        , k = !0;
                    if (n.isChildOf(o.target || o.srcElement, e.$root) || (h = !1,
                            y = null),
                        h && (k = !n.locateClassName(o, "task_end_date"),
                            h = !!y),
                            r = y,
                            i = h,
                            a = k,
                        ...
                        x && (w = Math.floor(x.offsetWidth / 2)),
                            this._dir_end = f(b, !!a, w, $)
                    } else
                        this._dir_end = n.getRelativeEventPosition(o, t.$task_data);
                    var S = !(v == h && _ == y && m == k);
                    return S && (_ && e.refreshTask(_, !1),
                    y && e.refreshTask(y, !1)),
                    S && g(c.marker),
                        function(i, n, r, a) {
                            var s = function() {
                                u._direction || (u._direction = document.createElement("div"),
                            ...
                            var g = Math.sin(f)
                                ...
                                , v = Math.round(n)
                                , m = Math.round(i)
                                , y = ["-webkit-transform: rotate(" + f + "rad)", "-moz-transform: rotate(" + f + "rad)", "-ms-transform: rotate(" + f + "rad)", "-o-transform: rotate(" + f + "rad)", "transform: rotate(" + f + "rad)", "width:" + Math.round(d) + "px"];
                ...
                u.attachEvent("onDragEnd", e.bind(function() {
                    ...
                    u._direction && (u._direction.parentNode && u._direction.parentNode.removeChild(u._direction),
                        u._direction = null)
                }, this))
        };
        t.exports = {
                        ...
                        return t = function(t, e) {
                            ...
                            return {
                                ...
                                _resize: function(i, n, r) {
                                    ...
                                    r.left ? (i.start_date = e.dateFromPos(s.start + n),
                                    i.start_date || (i.start_date = new Date(e.getState().min_date))) : (i.end_date = e.dateFromPos(s.end + n),
                                ...
                                _move: function(t, i, n) {
                                    ...
                                    a ? s ? (t.start_date = a,
                                        t.end_date = s) : (t.end_date = new Date(e.getState().max_date),
                                ...
                                on_mouse_down: function(i, r) {
                                    if (2 != i.button || void 0 === i.button) {
                                        var a = t.$getConfig()
                                            , s = e.locate(i)
                                            , o = null;
                                        if (e.isTaskExists(s) && (o = e.getTask(s)),
                                                ...
                                                if (c.mode && c.mode != a.drag_mode.ignore && a["drag_" + c.mode]) {
                                                    if (s = e.locate(r),
                                                        ...
                                                        return this.clear_drag_state(),
                                                            !1;
                                                    if (e.isSummaryTask(o) && !a.drag_project && c.mode != a.drag_mode.progress)
        ...
        t.exports = {
            ...
            highlightPosition: function(t, e, i) {
                var a = function(t, e) {
                    ...
                    return o > i.y + c - l.row_height && (o = i.y + c - l.row_height),
                        i.x = s,
                        i.y = o,
                        i
                }(t, i);
                e.marker.style.left = "10px",
                    e.marker.style.top = a.y + "px";
                var s = e.markerLine;
                s || ((s = document.createElement("div")).className = "gantt_drag_marker gantt_grid_dnd_marker",
                    ...
                    t.child ? function(t, e, i) {
                        ...
                        var n = function(t, e) {
                            var i = e.$config.rowStore
                                ...
                                , s = 15
                                , o = 0;
                            if (a && (s = a.offsetWidth),
                                t.targetId !== i.$getRootId()) {
                                var l = e.getItemTop(t.targetId)
                                    , c = e.getItemHeight(t.targetId);
                                if (o = i.exists(t.targetId) ? i.calculateItemLevel(i.getItem(t.targetId)) : 0,
                                        t.prevSibling)
                                    n.y = l;
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t, e, i, r, a) {
            var s;
            if (e !== a.$getRootId())
                s = i < .25 ? n.prevSiblingTarget(t, e, a) : !(i > .6) || a.hasChild(e) && a.getItem(e).$open ? n.firstChildTarget(t, e, a) : n.nextSiblingTarget(t, e, a);
            else {
                var o = a.$getRootId();
    ...
    , function(t, e, i) {
        ...
        function r(t, e, i, r, a) {
            for (var s = e; r.exists(s); ) {
                ...
                if ((o === i || o === i - 1) && r.getBranchIndex(s) > -1)
                    break;
        ...
        t.exports = function(t, e, i, r, o, l) {
            var c;
            if (e !== o.$getRootId())
                i < .5 ? o.calculateItemLevel(o.getItem(e)) === l ? c = o.getPrevSibling(e) ? n.nextSiblingTarget(t, o.getPrevSibling(e), o) : n.prevSiblingTarget(t, e, o) : (c = a(t, e, l, o)) && (c = s(t, e, l, o)) : o.calculateItemLevel(o.getItem(e)) === l ? c = n.nextSiblingTarget(t, e, o) : (c = s(t, e, l, o)) && (c = a(t, e, l, o));
            else {
                var d = o.$getRootId()
                    , h = o.getChildren(d);
                c = n.createDropTargetObject(),
                    c = h.length && r >= 0 ? a(t, function(t) {
            ...
            init: function(t, e) {
                ...
                if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                    ...
                    t.defined(e.$getConfig().dnd_sensitivity) && (l.config.sensitivity = e.$getConfig().dnd_sensitivity),
                        l.attachEvent("onBeforeDragStart", t.bind(function(i, n) {
                            var r = c(n);
                            if (!r)
                                return !1;
                            t.hideQuickInfo && t._hideQuickInfo();
                            var a = r.getAttribute(e.$config.item_attribute)
                                , s = e.$config.rowStore.getItem(a);
                            return !t.isReadonly(s) && (l.config.initial_open_state = s.$open,
                            !!t.callEvent("onRowDragStart", [a, n.target || n.srcElement, n]) && void 0)
                        }, t)),
                        l.attachEvent("onAfterDragStart", t.bind(function(t, i) {
                            ...
                            var s = e.$config.rowStore
                                , o = s.getItem(l.config.id);
                            l.config.level = s.calculateItemLevel(o),
                        ...
                        l.attachEvent("onDragMove", t.bind(function(i, n) {
                            ...
                            return a && !1 !== t.callEvent("onBeforeRowDragMove", [l.config.id, a.targetParent, a.targetIndex]) || (a = r.createDropTargetObject(l.config.drop_target)),
                                o.highlightPosition(a, l.config, e),
                        ...
                        l.attachEvent("onDragEnd", t.bind(function() {
                            ...
                            o.removeLineHighlight(l.config),
                                i.$transparent = !1,
                ...
                function d(t) {
                    ...
                    return i !== o.$getRootId() && (r = (d - e.getItemTop(i)) / e.getItemHeight()),
                        c ? a(l.config.id, i, r, d, o, l.config.level) : s(l.config.id, i, r, d, o)
                }
            }
        }
    }
                    ...
                    t.defined(e.$getConfig().dnd_sensitivity) && (r.config.sensitivity = e.$getConfig().dnd_sensitivity),
                        r.attachEvent("onBeforeDragStart", t.bind(function(i, n) {
                            ...
                            var l = o.getAttribute(e.$config.item_attribute)
                                , c = s().getItem(l);
                            return !t.isReadonly(c) && (r.config.initial_open_state = c.$open,
                            !!t.callEvent("onRowDragStart", [l, n.target || n.srcElement, n]) && void 0)
                        }, t)),
                        ...
                        r.lastTaskOfLevel = function(t) {
                            for (var e = null, i = s().getItems(), n = 0, r = i.length; n < r; n++)
                                i[n].$level == t && (e = i[n]);
                            return e ? e.id : null
                        }
                        ,
                        ...
                        r.attachEvent("onDragMove", t.bind(function(t, i) {
                            ...
                            if (l.exists(h) || (h = r.lastTaskOfLevel(o.order_branch_free ? c.$level : 0)) == r.config.id && (h = null),
                                    l.exists(h)) {
                                var f = l.getItem(h);
                                if (l.getIndexById(f.id) * o.row_height + o.row_height / 2 < d) {
                                    var g = l.getIndexById(f.id)
                                        , _ = l.getNext(f.id)
                                        , p = l.getItem(_);
                                    if (p) {
                                        if (p.id == c.id)
                                            return o.order_branch_free && l.isChildOf(c.id, f.id) && 1 == l.getChildren(f.id).length ? void l.move(c.id, l.getBranchIndex(f.id) + 1, l.getParent(f.id)) : void 0;
                                        f = p
                                    } else if (_ = l.getIdByIndex(g),
                                        u(p = l.getItem(_), c) && p.id != c.id)
                                        return void l.move(c.id, -1, l.getParent(p.id))
                                } else if (o.order_branch_free && f.id != c.id && u(f, c)) {
                                    if (!l.hasChild(f.id))
                                        return f.$open = !0,
                                            void l.move(c.id, -1, f.id);
                                    if (l.getIndexById(f.id) || o.row_height / 3 < d)
                                        return
                                }
                                g = l.getIndexById(f.id);
                                for (var v = l.getIdByIndex(g - 1), m = l.getItem(v), y = 1; (!m || m.id == f.id) && g - y >= 0; )
                                    v = l.getIdByIndex(g - y),
                                        m = l.getItem(v),
                                        y++;
                                if (c.id == f.id)
                                    return;
                    ...
                    this._mouseDelegates.delegate("click", "gantt_row", e.bind(function(i, n, r) {
                        ...
                        this._mouseDelegates.delegate("click", "gantt_grid_head_cell", e.bind(function(i, n, r) {
                            ...
                            if (e.callEvent("onGridHeaderClick", [a, i])) {
                                ...
                                if ("add" != a) {
                                    if (s.sort) {
                                        for (var o, l = a, c = 0; c < s.columns.length; c++)
                                            if (s.columns[c].name == a) {
                                                o = s.columns[c];
                                                break
                                            }
                                    ...
                                    e.$services.getService("mouseEvents").callHandler("click", "gantt_add", t.$grid, [i, s.root_id])
                            }
                        }, e), t.$grid),
        ...
        t.exports = function(t) {
            return function(e, i) {
                ...
                for (var l = [], c = 0; c < r.length; c++) {
                    ...
                    "add" == g.name ? (h = "<div " + (y = t._waiAria.gridAddButtonAttrString(g)) + " class='gantt_add'></div>",
                        u = "") : (h = g.template ? g.template(e) : e[g.name],
                    n.isDate(h) && (h = s.date_grid(h, e)),
                        u = h,
                        h = "<div class='gantt_tree_content'>" + h + "</div>");
                    var _ = "gantt_cell" + (f ? " gantt_last_cell" : "")
                        , p = [];
                    if (g.tree) {
                        for (var v = 0; v < e.$level; v++)
                            p.push(s.grid_indent(e));
                        o.hasChild(e.id) && !t.isSplitTask(e) ? (p.push(s.grid_open(e)),
                            p.push(s.grid_folder(e))) : (p.push(s.grid_blank(e)),
                            p.push(s.grid_file(e)))
                    }
                    var m = "width:" + (g.width - (f ? 1 : 0)) + "px;";
                    this.defined(g.align) && (m += "text-align:" + g.align + ";");
                    var y = t._waiAria.gridCellAttrString(g, u);
                    p.push(h),
                    a.rtl && (p = p.reverse()),
                        d = "<div class='" + _ + "' data-column-index='" + c + "' data-column-name='" + g.name + "' style='" + m + "' " + y + ">" + p.join("") + "</div>",
                        l.push(d)
                }
                if (_ = t.getGlobalTaskIndex(e.id) % 2 == 0 ? "" : " odd",
                        _ += e.$transparent ? " gantt_transparent" : "",
                        _ += e.$dataprocessor_class ? " " + e.$dataprocessor_class : "",
                        s.grid_row_class) {
                ...
                a.smart_rendering && (b.style.position = "absolute",
                    b.style.left = "0px",
        ...
        t.exports = function(t) {
                ...
                get_points: function(i, n) {
                    ...
                    if (d.from_start && d.to_start)
                        this.point_to(l.left, c),
                            h ? (this.point_to(l.down, s),
                                this.point_to(l.right, o)) : (this.point_to(l.right, o),
                        ...
                        d.from_start || d.to_start ? d.from_start && !d.to_start && (h = r.e_x > r.x - 2 * c,
                            this.point_to(l.left, c),
                            h ? (o += 2 * c,
                                u = s > 0 ? 1 : -1,
                                this.point_to(l.down, u * (a.row_height / 2)),
                                this.point_to(l.right, o),
                                this.point_to(l.down, u * (Math.abs(s) - a.row_height / 2)),
                                this.point_to(l.left, c)) : (o += c,
                                this.point_to(l.down, s),
                                this.point_to(l.right, o))) : (this.point_to(l.right, c),
                            h ? (this.point_to(l.right, o),
                                this.point_to(l.down, s)) : (this.point_to(l.down, s),
                                this.point_to(l.right, o)),
                            this.point_to(l.left, c));
                    return this.path
                },
            ...
            return function(n, r) {
                ...
                a.highlight_critical_path && t.isCriticalLink && t.isCriticalLink(n) && (h += " gantt_critical_link"),
                    d.className = h,
                r.$config.link_attribute && d.setAttribute(r.$config.link_attribute, n.id);
                for (var f = 0; f < c.length; f++) {
                    f == c.length - 1 && (c[f].size -= a.link_arrow_size);
                    var g = e.render_line(c[f], c[f + 1], r);
                    n.color && (g.firstChild.style.backgroundColor = n.color),
                        d.appendChild(g)
                }
                var _ = c[c.length - 1].direction
                    , p = function(t, i, n) {
                    var r = n.$getConfig()
                        , a = document.createElement("div")
                        , s = t.y
        ...
        t.exports = function(t) {
            return function(e, i) {
                ...
                if (n.show_task_cells)
                    for (var l = 0; l < s; l++) {
                        ...
                        if (c > 0) {
                            ...
                            h.style.width = c + "px",
                                d = "gantt_task_cell" + (l == s - 1 ? " gantt_last_cell" : ""),
                            (f = r.task_cell_class(e, a.trace_x[l])) && (d += " " + f),
                                h.className = d,
                                o.appendChild(h)
                        }
                    }
                var u = t.getGlobalTaskIndex(e.id) % 2 != 0
                    ...
                    , g = "gantt_task_row" + (u ? " odd" : "") + (f ? " " + f : "");
                return i.$config.rowStore.getSelectedId() == e.id && (g += " gantt_selected"),
                    o.className = g,
                n.smart_rendering && (o.style.position = "absolute",
    ...
    , function(t, e, i) {
        t.exports = function(t) {
            ...
            return i(2)(r, e),
                n.mixin(r.prototype, {
                    show: function(t, e, i, n) {
                        for (var r = "<div><select name='" + e.name + "'>", a = [], s = i.options || [], o = 0; o < s.length; o++)
                            a.push("<option value='" + i.options[o].key + "'>" + s[o].label + "</option>");
                        r += a.join("") + "</select></div>",
                            n.innerHTML = r
                    },
                    get_input: function(t) {
                ...
                a.attachEvent("onBeforeFocus", function(e) {
                    ...
                    if (clearTimeout(r),
                        ...
                        var a = n.columnName
                            , s = n.id
                            , o = i.getState();
                        if (i.isVisible() && o.id == s && o.columnName === a)
                            return !1
                    }
                    return !0
                }),
                    ...
                    a.attachEvent("onKeyDown", function(e, r) {
                        ...
                        switch (d) {
                            case c.ENTER:
                                t.isVisible() ? (t.save(),
                                    r.preventDefault(),
                                    h = !0) : o && !(r.ctrlKey || r.metaKey || r.shiftKey) && (i.startEdit(s.id, s.columnName),
                                    r.preventDefault(),
                                    h = !0);
                                break;
                            case c.ESC:
                            ...
                            case c.SPACE:
                                t.isVisible() && (h = !0),
                                o && !t.isVisible() && (i.startEdit(s.id, s.columnName),
                                    r.preventDefault(),
                                    h = !0);
                                break;
                            case c.DELETE:
                            ...
                            default:
                                if (t.isVisible())
                                    h = !0;
                                else if (d >= 48 && d <= 57 || d > 95 && d < 112 || d >= 64 && d <= 91 || d > 185 && d < 193 || d > 218 && d < 223) {
                                    var f = e.modifiers
                                        , g = f.alt || f.ctrl || f.meta || f.shift;
                                    f.alt || g && a.getCommandHandler(e, "taskCell") || o && !t.isVisible() && (i.startEdit(s.id, s.columnName),
                                        h = !0)
                                }
                        }
                        return !h
                    ...
                    var a = []
                        ...
                        startEdit: function(t, e) {
                            if (this.isVisible() && this.save(),
                                ...
                                !1 !== this.callEvent("onBeforeEditStart", [i]) && (this.show(i.id, i.columnName),
                                    this.setValue(),
                                ...
                                if (s.exists(e)) {
                                    ...
                                    if (!1 !== this.callEvent("onBeforeSave", [o]) && this._editor.is_valid(o.newValue, o.id, o.columnName, this._placeholder)) {
                                        var l = a.map_to
                                            , c = o.newValue;
                                        "auto" != l ? (r[l] = c,
                                            "duration" == l ? r.end_date = t.calculateEndDate(r) : "end_date" == l ? r.start_date = t.calculateEndDate({
                                                start_date: r.end_date,
                                                duration: -r.duration,
                                                task: r
                                            }) : "start_date" == l && (r.end_date = t.calculateEndDate(r)),
            ...
            var i = {
                ...
                column_drag_move: t.bind(function(i, r, a) {
                    var s = e.$getConfig()
                        , o = i.config
                        , l = e.getGridColumns()
                        , c = parseInt(o.drag_index, 10)
                        , d = l[c]
                        , h = n.getNodePosition(e.$grid_scale)
                        , u = parseInt(o.marker.style.left, 10)
                        , f = d.min_width ? d.min_width : s.min_grid_column_width
                        , g = e.$grid_data.offsetWidth
                        , _ = 0
                        , p = 0;
                    ...
                    if (u < f && (u = f),
                        ...
                        for (v = c + 1; v < l.length; v++)
                            l[v].min_width ? g -= l[v].min_width : s.min_grid_column_width && (g -= s.min_grid_column_width),
                    ...
                    return o.left = u - 1,
                        p = Math.abs(u - _),
                    d.max_width && p > d.max_width && (p = d.max_width),
                    s.rtl && (_ = h.width - _ + 2 - p),
                        o.marker.style.top = h.y + "px",
                        o.marker.style.left = h.x - 1 + _ + "px",
                        o.marker.style.width = p + "px",
                        e.callEvent("onColumnResize", [c, l[c], p - 1]),
                        !0
                }, t),
                column_drag_end: t.bind(function(i, n, r) {
                    for (var a = e.$getConfig(), s = e.getGridColumns(), o = 0, l = parseInt(i.config.drag_index, 10), c = s[l], d = 0; d < l; d++)
                        o += s[d].width;
                    var h = c.min_width && i.config.left - o < c.min_width ? c.min_width : i.config.left - o;
                    if (c.max_width && c.max_width < h && (h = c.max_width),
                        !1 !== e.callEvent("onColumnResizeEnd", [l, c, h]) && c.width != h) {
                        if (c.width = h,
                                a.keep_grid_width)
                            o = a.grid_width;
                        else {
                            d = l;
                            for (var u = s.length; d < u; d++)
                                o += s[d].width
                        }
                        e.callEvent("onColumnResizeComplete", [s, e._setColumnsWidth(o, l)]),
                ...
                doOnRender: function() {
                    for (var i = e.getGridColumns(), n = e.$getConfig(), r = 0, a = e.$config.width, s = n.scale_height, o = 0; o < i.length; o++) {
                        ...
                        if (r += c.width,
                                ...
                                c.resize) {
                            var d = document.createElement("div");
                            d.className = "gantt_grid_column_resize_wrap",
                                d.style.top = "0px",
                                d.style.height = s + "px",
                                d.innerHTML = "<div class='gantt_grid_column_resize'></div>",
                                d.setAttribute(n.grid_resizer_column_attribute, o),
                                t._waiAria.gridSeparatorAttr(d),
                                e.$grid_scale.appendChild(d),
                                d.style.left = Math.max(0, l) + "px"
                        }
                    }
                }
            }
        ...
        var n = i(0)
            ...
            function l(t, e, i) {
                ...
                return function(t, e, i, n, a, s) {
                    ...
                    for (var c = 1 * s.rightBorderWidth, d = r(s.rightBorderColor), h = 0, u = 0, f = 0, g = 1; g <= n; g++)
                        for (h = g * e - 1,
                                 f = 0; f < c; f++)
                            for (u = 0; u < t * i; u++)
                                l(h - f, u, d, o);
                    var _ = 1 * s.bottomBorderWidth
            ...
            return {
                ...
                iterateScales: function(t, e, i, n, r) {
                    for (var a = e.trace_x, s = t.trace_x, o = i || 0, l = n || s.length - 1, c = 0, d = 1; d < a.length; d++) {
                        ...
                        void 0 !== h && h <= l && (r && r.apply(this, [c, d, o, h]),
                            o = h,
                            c = d)
                    }
                },
                ...
                eachColumn: function(i, n, r, a, s) {
                    ...
                    for (+c >= +l && (l = e.add(c, n, i)); +c < +l; ) {
                        ...
                        c = e.add(c, n, i),
                            c = t._correct_dst_change(c, d, n, i),
                ...
                limitVisibleRange: function(t) {
                    ...
                    if (+l > +t.max_date && s > 0 && (a = t.width[s] - Math.floor(t.width[s] * ((l - t.max_date) / (l - o))),
                            r += t.width[s] - a,
                            t.width[s] = a),
                            r) {
        ...
        var n = i(2)
            ...
            function e(e, i, n, r) {
                ...
                return r.env.isIE && (o += 1),
                    this._isHorizontal() ? (s.$config.height = o,
                        s.$parent.$config.height = o) : (s.$config.width = o,
                        s.$parent.$config.width = o),
            ...
            return n(e, t),
                ...
                e.prototype._getScrollSize = function() {
                    for (var t, e = 0, i = 0, n = this._isHorizontal(), r = this._getLinkedViews(), a = n ? "scrollWidth" : "scrollHeight", s = n ? "contentX" : "contentY", o = n ? "x" : "y", l = this._getScrollOffset(), c = 0; c < r.length; c++)
                        if ((t = r[c]) && t.$content && t.$content.getSize && !t.$config.hidden) {
                            var d, h = t.$content.getSize();
                            if (d = h.hasOwnProperty(a) ? h[a] : h[s],
                                    l)
                                h[s] > h[o] && h[s] > e && d > h[o] - l + 2 && (e = d + (n ? 0 : 2),
                                    i = h[o]);
                            else {
                                var u = Math.max(h[s] - d, 0);
                                (d += u) > Math.max(h[o] - u, 0) && d > e && (e = d,
                                    i = h[o])
                            }
                        }
                    return {
                ...
                e.prototype._mouseWheelHandler = function(t) {
                    ...
                    if (this._checkWheelTarget(e)) {
                        ...
                        if (!t.shiftKey || t.deltaX || t.wheelDeltaX || (r = 2 * a,
                            ...
                            if (this.scrollVertically(h),
                                    this.$scroll_ver.scrollTop = h,
                                d == this.$scroll_ver.scrollTop)
                                return !0;
                            this._oldTop = this.$scroll_ver.scrollTop
                        }
        ...
        var n = i(2)
            ...
            function e(e, i, n) {
                ...
                return s._moveHandler = function(t) {
                    ...
                    s._upHandler = function() {
                        ...
                        !1 !== s.callEvent("onResizeEnd", [r, a, t ? t.back : 0, t ? t.front : 0]) && s._setSizes(),
                            s._setBackground(!1),
                            s._clearResizer(),
                            s._clearListeneres()
                    }
                    ...
                    s._startOnMove = function(t) {
                        s._isPosChanged(t) && (s._clearListeneres(),
                            s._startDND(t))
                    }
                    ,
                    s._downHandler = function(t) {
                        s._getSiblings(),
                        s._behind.$config.collapsed || s._front.$config.collapsed || (s._setBackground(!0),
            ...
            return n(e, t),
                ...
                e.prototype._getSiblings = function() {
                    ...
                    this._behind instanceof s || (this._behind = this._behind.$parent)),
                    this.$config.next && (this._front = this.$factory.getView(this.$config.next),
                    this._front instanceof s || (this._front = this._behind.$parent));
                    for (var e = 0; e < t.length; e++)
                ...
                e.prototype._getResizePosition = function(t, e) {
                    ...
                    this._xMode ? (i = t - this._positions.x,
                        ...
                        s = this._front.$config.minWidth) : (i = e - this._positions.y,
            ...
            return {
                createGroup: function(i, n, o) {
                    var l = {
                        ...
                        _add: function(t) {
                            t && (t.id = t.id || r.uid(),
                                this.tempCollection.push(t));
                            for (var i = this.container(), s = this.tempCollection, o = 0; o < s.length; o++)
                                if (t = s[o],
                                    this.container() || t && t.container && a.isChildOf(t.container, document.body)) {
                                    var l = t.container
                                        , c = t.id
                                        , d = t.topmost;
                                    if (!l.parentNode)
                                    ...
                                    this.renderers[c] = e.getRenderer(c, t, l),
                        ...
                        addLayer: function(t) {
                            return t && ("function" == typeof t && (t = {
                                ...
                                void 0 === t.filter ? t.filter = s(o || []) : t.filter instanceof Array && (t.filter.push(o),
                                    t.filter = s(t.filter)),
    ...
    , function(t, e, i) {
        var n = function(t) {
            return function(e) {
                ...
                function h(t) {
                    d.detachAll(),
                    t && (d.attach(t, "click", r),
                        d.attach(t, "dblclick", l),
                        d.attach(t, "mousemove", c),
                        d.attach(t, "contextmenu", a))
                }
                return {
                    reset: h,
                    ...
                    callHandler: function(t, e, n, r) {
                        ...
                        if (a)
                            for (var s = 0; s < a.length; s++)
                                (n || a[s].root) && a[s].root !== n || a[s].handler.apply(this, r)
                    },
                    onDoubleClick: l,
                    onMouseMove: c,
                    onContextMenu: a,
        ...
        t.exports = {
            createFactory: function(t) {
                ...
                function a(a, s, o, l) {
                    ...
                    return c.configure && c.configure(d),
                        r(d, l),
                    d.$id || (d.$id = o.id || t.uid()),
                    d.$parent || "object" != typeof s || (d.$parent = s),
                    d.$config || (d.$config = o),
                    i[d.$id] && (d.$id = t.uid()),
                        i[d.$id] = d,
                        d
        ...
        t.exports = {
            init: function(t) {
                ...
                i.registerView("cell", s),
                    ...
                    i.registerView("resourceGrid", g),
                    i.registerView("resourceTimeline", _),
                    i.registerView("resourceHistogram", p);
                var T = a(t)
                    , E = v(t);
                return t.ext.inlineEditors = E,
                    t.ext._inlineEditors = E,
                    E.init(t),
                    {
                        factory: i,
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t) {
                ...
                if (i) {
                    ...
                    if (p.keyboard) {
                        if (13 == e || 32 == e) {
                            ...
                            r.getClassName(s).indexOf("gantt_popup_button") > -1 && s.click ? s.click() : (a(i, !0),
                                n = !0)
                        }
                        27 == e && (a(i, !1),
                            n = !0)
            ...
            function o(t) {
                o.cover || (o.cover = document.createElement("div"),
                    o.cover.onkeydown = s,
            ...
            function d(r, d, h) {
                var u = r.tagName ? r : function(r, s, o) {
                    var d = document.createElement("div")
                        , h = n.uid();
                    t._waiAria.messageModalAttr(d, h),
                        d.className = " gantt_modal_box dhtmlx_modal_box gantt-" + r.type + " dhtmlx-" + r.type,
                        d.setAttribute(e, 1);
                    var u = "";
                    if (r.width && (d.style.width = r.width),
                        r.height && (d.style.height = r.height),
                        r.title && (u += '<div class="gantt_popup_title dhtmlx_popup_title">' + r.title + "</div>"),
                            u += '<div class="gantt_popup_text dhtmlx_popup_text" id="' + h + '"><span>' + (r.content ? "" : r.text) + '</span></div><div  class="gantt_popup_controls dhtmlx_popup_controls">',
                        s && (u += l(c(r.ok, t.locale.labels.message_ok, "OK"), "ok", !0)),
                        o && (u += l(c(r.cancel, t.locale.labels.message_cancel, "Cancel"), "cancel", !1)),
                            r.buttons)
                        for (var f = 0; f < r.buttons.length; f++) {
                            var g = r.buttons[f];
                            u += "object" == typeof g ? l(g.label, g.css || "gantt_" + g.label.toLowerCase() + "_button dhtmlx_" + g.label.toLowerCase() + "_button", g.value || f) : l(g, g, f)
                        }
                    if (u += "</div>",
                            d.innerHTML = u,
                            r.content) {
                        ...
                        "none" == _.style.display && (_.style.display = ""),
                            d.childNodes[r.title ? 1 : 0].appendChild(_)
                    }
                ...
                var f = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - u.offsetWidth) / 2))
                    , g = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - u.offsetHeight) / 2));
                return "top" == r.position ? u.style.top = "-3px" : u.style.top = g + "px",
                    u.style.left = f + "px",
                    u.onkeydown = s,
                    _.focus(u),
                r.hidden && _.hide(u),
        ...
        t.exports = function t(e, i) {
            ...
            return {
                ...
                detach: function(t, e, n, a) {
                    i(t, e, n, a);
                    for (var s = 0; s < r.length; s++)
                        (n = r[s]).element === t && n.event === e && n.callback === n && n.capture === a && (r.splice(s, 1),
                            s--)
                },
                detachAll: function() {
    ...
    , function(t, e) {
        t.exports = function(t) {
            ...
            function i(i, n, r) {
                ...
                var a = t.config
                    , s = t.templates;
                t.config[i] && e[r] != a[i] && (n && s[r] || (s[r] = t.date.date_to_str(a[i]),
                    e[r] = a[i]))
            }
            return {
            ...
            return i.prototype = {
                ...
                dragMove: function(e, i, n) {
                    ...
                    if (r) {
                        ...
                        return this.config.ignore ? void 0 : (r.pos = this.getPosition(r),
        ...
        t.exports = function(t) {
            var e = {
                ...
                parseDate: function(e, i) {
                    return e && !e.getFullYear && (t.defined(i) && (i = "string" == typeof i ? t.defined(t.templates[i]) ? t.templates[i] : t.date.str_to_date(i) : t.templates.xml_date),
                        e = e ? i(e) : null),
                        e
                }
            };
                ...
                _call: function(e, i, r, a, s, o, l) {
                    ...
                    if (a && (c.onreadystatechange = function() {
                                if (4 == c.readyState || d && 3 == c.readyState) {
                                    if ((200 != c.status || "" === c.responseText) && !t.callEvent("onAjaxError", [c]))
                                        return;
                                    window.setTimeout(function() {
                        ...
                        "GET" != e || this.cache || (i += (i.indexOf("?") >= 0 ? "&" : "?") + "dhxr" + (new Date).getTime() + "=1"),
                            ...
                            l)
                        for (var h in l)
                            c.setRequestHeader(h, l[h]);
                    else
                        "POST" == e.toUpperCase() || "PUT" == e || "DELETE" == e ? c.setRequestHeader("Content-Type", "application/x-www-form-urlencoded") : "GET" == e && (r = null);
                    if (c.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
                            c.send(r),
                            !a)
                        return {
                            xmlDoc: c,
    ...
    , function(t, e, i) {
        i(16),
            t.exports = function() {
                ...
                ;
                i(142)(t),
                    t.$services = t.$inject(i(141)),
                    t.config = t.$inject(i(140)),
                    t.ajax = i(139)(t),
                    t.date = i(138)(t);
                var e = i(137)(t);
    ...
    , function(t, e, i) {
        var n = {
            ...
            getGanttInstance: function() {
                for (var t = i(144)(), e = 0; e < n._ganttPlugin.length; e++)
                    n._ganttPlugin[e](t);
